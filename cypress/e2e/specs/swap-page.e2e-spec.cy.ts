...
describe('Token Catalog', () => {
  ...
  describe('Select token by symbol', () => {
    it('Should be selected tokenIn by symbol successfully', { tags: ['smoke', 'regression'] }, () => {
      cy.clickButton(token.tokenIn)
    ...
    it('Should be unselected tokenIn not exist in whitelist', { tags: ['smoke', 'regression'] }, () => {
      cy.clickButton(token.tokenIn)
  ...
  describe('Import token', () => {
    it('Should be imported tokenIn successfully', { tags: ['smoke', 'regression'] }, () => {
  ...
  describe('Delete token', () => {
    it('Should be deleted the imported tokenIn successfully', { tags: ['smoke', 'regression'] }, () => {
      cy.importNewTokenByAddress(token.tokenIn, unWhiteListedToken.SCOOBY.address)
      cy.clickButton(token.tokenIn)
      cy.clickButton(tab.import)
      cy.verifyValueInList(token.rowInWhiteList, [unWhiteListedToken.SCOOBY.name], true)
