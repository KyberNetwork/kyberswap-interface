...
const solanaInfo: EVMNetworkInfo = {
  chainId: ChainId.SOLANA,
  route: 'solana',
  name: 'Solana',
  icon: Solana,
  classicClient: createClient('https://api.thegraph.com/subgraphs/name/viet-nv/kyberswap-classic-solana'),
  elasticClient: createClient('https://api.thegraph.com/subgraphs/name/viet-nv/promm-solana'),
  blockClient: createClient('https://api.thegraph.com/subgraphs/name/edwardevans094/solana-blocks'),
  etherscanUrl: 'https://solscan.io',
  etherscanName: 'Solana scan',
  tokenListUrl: `${process.env.REACT_APP_TOKEN_LIST_API}?chainId=${ChainId.SOLANA}`,
  bridgeURL: EMPTY,
  nativeToken: {
    symbol: 'SOL',
    decimal: 9,
