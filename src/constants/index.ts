...
export const ZAP_ADDRESSES: { [chainId in ChainId]?: string } = {
  ...
  [ChainId.VELAS]: '0x83D4908c1B4F9Ca423BEE264163BC1d50F251c31', //todo namgold: velas
}
...
export const ROUTER_ADDRESSES: { [chainId in ChainId]: string } = {
  ...
  [ChainId.VELAS]: '0xEaE47c5D99f7B31165a7f0c5f7E0D6afA25CFd55', //todo namgold: velas
}
...
export const ROUTER_ADDRESSES_V2: { [chainId in ChainId]?: string } = {
  ...
  [ChainId.VELAS]: '0xdf1a1b60f2d438842916c0adc43748768353ec25', //todo namgold: velas
}
...
export const AGGREGATION_EXECUTOR: { [chainId in ChainId]?: string } = {
  ...
  [ChainId.VELAS]: '0xd12bcdfb9a39be79da3bdf02557efdcd5ca59e77', //todo namgold: velas
}
...
export const FACTORY_ADDRESSES: { [chainId in ChainId]: string } = {
  ...
  [ChainId.VELAS]: '0xD9bfE9979e9CA4b2fe84bA5d4Cf963bBcB376974', //todo namgold: velas
}
...
export const USDC: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.VELAS]: new Token(ChainId.VELAS, '0xCa424b845497f7204D9301bd13Ff87C0E2e86FCF', 18, 'USDC_b', 'USD Coin_BSC'), //todo namgold: velas
}
...
export const USDT: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.VELAS]: new Token(ChainId.VELAS, '0x9B5F27f6ea9bBD753ce3793a07CbA3C74644330d', 18, 'USDT_b', 'Tether USD_BSC'), //todo namgold: velas
}
...
export const AVERAGE_BLOCK_TIME_IN_SECS: { [chainId in ChainId]: number } = {
  ...
  [ChainId.BTTC]: 2,
  [ChainId.VELAS]: 2, //todo namgold: velas
}
...
export const BLOCKS_PER_YEAR: { [chainId in ChainId]: number } = {
  ...
  [ChainId.VELAS]: Math.floor((60 / AVERAGE_BLOCK_TIME_IN_SECS[ChainId.ARBITRUM]) * 60 * 24 * 365), //todo namgold: velas
}
...
export const UNI: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.VELAS]: new Token(ChainId.VELAS, UNI_ADDRESS, 18, 'UNI', 'Uniswap'), //todo namgold: velas
}
...
export const KNC: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.VELAS]: new Token(ChainId.VELAS, KNC_ADDRESS, 18, 'KNC', 'Kyber Network Crystal'), //todo namgold: velas
}
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.VELAS]: [...WETH_ONLY[ChainId.VELAS], DAI[ChainId.VELAS], USDC[ChainId.VELAS], USDT[ChainId.VELAS]], //todo namgold: velas
}
...
export const ROPSTEN_TOKEN_LOGOS_MAPPING: {
  ...
  'VELAS': 'VELAS', //todo namgold: velas
}
