...
export const ROUTER_ADDRESSES_V2: { [chainId in ChainId]?: string } = {
  [ChainId.BSCMAINNET]: process.env.REACT_APP_ROUTER_ADDRESSES_V2,
  [ChainId.MATIC]: process.env.REACT_APP_ROUTER_ADDRESSES_V2,
  [ChainId.AVAXMAINNET]: process.env.REACT_APP_ROUTER_ADDRESSES_V2,
  [ChainId.MAINNET]: process.env.REACT_APP_ROUTER_ADDRESSES_V2,
  [ChainId.FANTOM]: process.env.REACT_APP_ROUTER_ADDRESSES_V2,
  [ChainId.CRONOS]: process.env.REACT_APP_ROUTER_ADDRESSES_V2,
  [ChainId.ARBITRUM]: process.env.REACT_APP_ROUTER_ADDRESSES_V2,
  [ChainId.BTTC]: process.env.REACT_APP_ROUTER_ADDRESSES_V2,
  [ChainId.AURORA]: process.env.REACT_APP_ROUTER_ADDRESSES_V2,
  [ChainId.VELAS]: process.env.REACT_APP_ROUTER_ADDRESSES_V2,
  [ChainId.OASIS]: process.env.REACT_APP_ROUTER_ADDRESSES_V2,
}

export const AGGREGATION_EXECUTOR_ADDRESSES: { [chainId in ChainId]?: string } = {
  [ChainId.BSCMAINNET]: process.env.REACT_APP_AGGREGATION_EXECUTOR_ADDRESSES,
  [ChainId.MATIC]: process.env.REACT_APP_AGGREGATION_EXECUTOR_ADDRESSES,
  [ChainId.AVAXMAINNET]: process.env.REACT_APP_AGGREGATION_EXECUTOR_ADDRESSES,
  [ChainId.MAINNET]: process.env.REACT_APP_AGGREGATION_EXECUTOR_ADDRESSES,
  [ChainId.FANTOM]: process.env.REACT_APP_AGGREGATION_EXECUTOR_ADDRESSES,
  [ChainId.CRONOS]: process.env.REACT_APP_AGGREGATION_EXECUTOR_ADDRESSES,
  [ChainId.BTTC]: process.env.REACT_APP_AGGREGATION_EXECUTOR_ADDRESSES,
  [ChainId.ARBITRUM]: process.env.REACT_APP_AGGREGATION_EXECUTOR_ADDRESSES,
  [ChainId.AURORA]: process.env.REACT_APP_AGGREGATION_EXECUTOR_ADDRESSES,
  [ChainId.VELAS]: process.env.REACT_APP_AGGREGATION_EXECUTOR_ADDRESSES,
