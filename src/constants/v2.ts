...
const V2_CORE_FACTORY_ADDRESS = '0x584bc3d0e4304e170A2B1347672911E93973D675'
export const PRO_AMM_CORE_FACTORY_ADDRESSES: ChainStringList = {
  ...
  [ChainId.RINKEBY]: '0x584bc3d0e4304e170A2B1347672911E93973D675',
...
export const PRO_AMM_NONFUNGIBLE_POSITION_MANAGER_ADDRESSES: ChainStringList = {
  ...
  [ChainId.RINKEBY]: '0xe967960A3e83738E68a0075aa4841e0D6AAA6218',
...
const QUOTER = '0xfa33723F6fA00a35F69F8aCd72A5BE9AF3c8Bd25'

export const PRO_AMM_QUOTER: ChainStringList = {
  [ChainId.MAINNET]: QUOTER,
  [ChainId.ROPSTEN]: QUOTER,
  [ChainId.RINKEBY]: '0xfa33723F6fA00a35F69F8aCd72A5BE9AF3c8Bd25',
...
export const PRO_AMM_ROUTERS: ChainStringList = {
  ...
  [ChainId.RINKEBY]: '0x12ba4d63f73E0Aa01Df9c74508f1D2714bF05198',
