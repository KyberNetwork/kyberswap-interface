...
export const PRO_AMM_CORE_FACTORY_ADDRESSES: ChainStringList = {
  ...
  [ChainId.BSCMAINNET]: '0x2C059Ab112EB6D4bDb6105742D560876A9Fe0f54',
...
export const PRO_AMM_NONFUNGIBLE_POSITION_MANAGER_ADDRESSES: ChainStringList = {
  ...
  [ChainId.BSCMAINNET]: '0x96891141A71001573E925aC356174e5D3a86Cbb8',
...
const INIT_CODE_HASH = '0x9af381b43515b80cfc9d1c3abe15a1ebd48392d5df2bcce1eb4940eea548c789'
...
export const PRO_AMM_INIT_CODE_HASH: ChainStringList = {
  ...
  [ChainId.BSCMAINNET]: '0x9af381b43515b80cfc9d1c3abe15a1ebd48392d5df2bcce1eb4940eea548c789',
...
export const PRO_AMM_QUOTER: ChainStringList = {
  ...
  [ChainId.BSCMAINNET]: '0x13c8F670d3bbd4456870a2C49Bb927F166A977Bd',
