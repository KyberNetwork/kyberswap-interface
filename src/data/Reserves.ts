...
import { STATIC_FEE_FACTORY_ADDRESSES, OLD_STATIC_FEE_FACTORY_ADDRESSES } from './../constants/index'
  ...
  return useMemo(() => {
    return results.map((result, i) => {
      ...
      const isOldStaticFeeContract =
        chainId && factoryAddresses && factoryAddresses[0] === OLD_STATIC_FEE_FACTORY_ADDRESSES[chainId]
      return [
        PairState.EXISTS,
        new Pair(
