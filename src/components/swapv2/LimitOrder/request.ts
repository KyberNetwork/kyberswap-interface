...
export const ackNotificationOrder = (docIds: string[], maker: string, chainId: ChainId) => {
  return axios
    .delete(`${LIMIT_ORDER_API_WRITE}/v1/events/cancelled-events`, {
      data: { maker, chainId: chainId + '', docIds },
    })
    .then(formatData)
}
