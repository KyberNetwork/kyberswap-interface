            ...
            <CampaignWrapper id={TutorialIds.CAMPAIGN_LINK}>
              ...
              >
                ...
                <Dropdown>
                  <StyledNavLink
                    id={`campaigns`}
                    to={APP_PATHS.CAMPAIGN}
                    isActive={() => pathname.toLowerCase().includes(APP_PATHS.CAMPAIGN)}
                  >
                  ...
                  <StyledNavLink
                    id="grant_programs"
                    to={APP_PATHS.GRANT_PROGRAMS}
                    isActive={() => pathname.toLowerCase().includes(APP_PATHS.GRANT_PROGRAMS)}
                  >
