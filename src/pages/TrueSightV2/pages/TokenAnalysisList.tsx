          ...
          <div>
            <Table>
              <colgroup>
                ...
                <col style={{ width: '320px', minWidth: '200px' }} />
                  ...
                  <tr key={token.id} onClick={() => navigate('/discover/single-token/' + testParams.address)}>
                    ...
                    <td>
                      <Row gap="4px" justify={'flex-end'}>
                        <ActionButton color={theme.subText} title="View Pools">
                          <Icon id="liquid" size={16} />
                        </ActionButton>
                        <ActionButton color={theme.subText}>
                          <Icon id="swap" size={16} />
                        </ActionButton>
                        <ActionButton color={theme.primary} onClick={() => navigate('/discover/single-token')}>
