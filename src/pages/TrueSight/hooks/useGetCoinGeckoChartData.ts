      ...
      if (tokenNetwork && tokenAddress) {
        try {
          ...
          if (tokenAddress === 'bnb') {
            ...
            // CAKE
            url = `${COINGECKO_API_URL}/coins/binance-smart-chain/contract/0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82/market_chart/range?vs_currency=usd&from=1649824248&to=1649910648`
          }
