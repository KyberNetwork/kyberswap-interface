...
describe('formatDisplayNumber tests', () => {
  ...
  describe('decimal', () => {
    describe('number', () => {
      ...
      describe('negative numbers', () => {
        test('format number -123456789123456789.123456789 correctly', () => {
    ...
    describe('string', () => {
      describe('large strings', () => {
        describe('2 significantDigits', () => {
          test('format string 1 correctly', () => {
            expect(formatDisplayNumber('1', { significantDigits: 2 })).toBe('1')
          })
          test('format string 12 correctly', () => {
            expect(formatDisplayNumber('12', { significantDigits: 2 })).toBe('12')
          })
          test('format string 123 correctly', () => {
            expect(formatDisplayNumber('123', { significantDigits: 2 })).toBe('120')
          })
          test('format string 1234 correctly', () => {
            expect(formatDisplayNumber('1234', { significantDigits: 2 })).toBe('1.2K')
          })
          test('format string 12345 correctly', () => {
            expect(formatDisplayNumber('12345', { significantDigits: 2 })).toBe('12K')
          })
          test('format string 123456 correctly', () => {
            expect(formatDisplayNumber('123456', { significantDigits: 2 })).toBe('120K')
          })
          test('format string 1234567 correctly', () => {
            expect(formatDisplayNumber('1234567', { significantDigits: 2 })).toBe('1.2M')
          })
          test('format string 12345678 correctly', () => {
            expect(formatDisplayNumber('12345678', { significantDigits: 2 })).toBe('12M')
          })
          test('format string 123456789 correctly', () => {
            expect(formatDisplayNumber('123456789', { significantDigits: 2 })).toBe('120M')
          })
      ...
      describe('small strings', () => {
        describe('2 significantDigits', () => {
          test('format string 123456.123456789 correctly', () => {
            expect(formatDisplayNumber('123456.123456789', { significantDigits: 2 })).toBe('120K')
          })
        ...
        describe('18 significantDigits', () => {
          test('format string 123456.123456789123456789123456789 correctly', () => {
            expect(formatDisplayNumber('123456.123456789123456789123456789', { significantDigits: 18 })).toBe(
              '123,456.12345678912',
            )
          })
          test('format string 12345.123456789123456789123456789 correctly', () => {
            expect(formatDisplayNumber('12345.123456789123456789123456789', { significantDigits: 18 })).toBe(
              '12,345.123456789124',
            )
          })
          test('format string 1234.123456789123456789123456789 correctly', () => {
            expect(formatDisplayNumber('1234.123456789123456789123456789', { significantDigits: 18 })).toBe(
              '1,234.1234567891236',
            )
          })
          test('format string 123.123456789123456789123456789 correctly', () => {
            expect(formatDisplayNumber('123.123456789123456789123456789', { significantDigits: 18 })).toBe(
              '123.12345678912345',
            )
          })
          test('format string 12.123456789123456789123456789 correctly', () => {
            expect(formatDisplayNumber('12.123456789123456789123456789', { significantDigits: 18 })).toBe(
              '12.123456789123457',
            )
          })
          test('format string 1.123456789123456789123456789 correctly', () => {
            expect(formatDisplayNumber('1.123456789123456789123456789', { significantDigits: 18 })).toBe(
              '1.1234567891234568',
            )
          })
          test('format string 0.123456789123456789123456789 correctly', () => {
            expect(formatDisplayNumber('0.123456789123456789123456789', { significantDigits: 18 })).toBe(
              '0.123456789123456789',
            )
          })
          test('format string 0.0123456789123456789123456789 correctly', () => {
            expect(formatDisplayNumber('0.0123456789123456789123456789', { significantDigits: 18 })).toBe(
              '0.0123456789123456789',
            )
          })
          test('format string 0.00123456789123456789123456789 correctly', () => {
            expect(formatDisplayNumber('0.00123456789123456789123456789', { significantDigits: 18 })).toBe(
              '0.00123456789123456789',
            )
          })
          test('format string 0.000123456789123456789123456789 correctly', () => {
            expect(formatDisplayNumber('0.000123456789123456789123456789', { significantDigits: 18 })).toBe(
              '0.0₃123456789123456789',
            )
          })
          test('format string 0.0000123456789123456789123456789 correctly', () => {
            expect(formatDisplayNumber('0.0000123456789123456789123456789', { significantDigits: 18 })).toBe(
              '0.0₄123456789123456789',
            )
          })
          test('format string 0.00000123456789123456789123456789 correctly', () => {
            expect(formatDisplayNumber('0.00000123456789123456789123456789', { significantDigits: 18 })).toBe(
              '0.0₅123456789123456789',
            )
          })
          test('format string 0.000000123456789123456789123456789 correctly', () => {
            expect(formatDisplayNumber('0.000000123456789123456789123456789', { significantDigits: 18 })).toBe(
              '0.0₆123456789123456789',
            )
          })
          test('format string 0.0000000123456789123456789123456789 correctly', () => {
            expect(formatDisplayNumber('0.0000000123456789123456789123456789', { significantDigits: 18 })).toBe(
              '0.0₇123456789123456789',
            )
          })
          test('format string 0.00000000123456789123456789123456789 correctly', () => {
            expect(formatDisplayNumber('0.00000000123456789123456789123456789', { significantDigits: 18 })).toBe(
              '0.0₈123456789123456789',
            )
          })
          test('format string 0.000000000123456789123456789123456789 correctly', () => {
            expect(formatDisplayNumber('0.000000000123456789123456789123456789', { significantDigits: 18 })).toBe(
              '0.0₉123456789123456789',
            )
          })
          test('format string 0.0000000000123456789123456789123456789 correctly', () => {
            expect(formatDisplayNumber('0.0000000000123456789123456789123456789', { significantDigits: 18 })).toBe(
              '0.0₁₀123456789123456789',
            )
          })
          test('format string 0.00000000000123456789123456789123456789 correctly', () => {
            expect(formatDisplayNumber('0.00000000000123456789123456789123456789', { significantDigits: 18 })).toBe(
              '0.0₁₁123456789123456789',
            )
          })
          test('format string 0.000000000000123456789123456789123456789 correctly', () => {
            expect(formatDisplayNumber('0.000000000000123456789123456789123456789', { significantDigits: 18 })).toBe(
              '0.0₁₂123456789123456789',
            )
          })
          test('format string 0.00000000000000000000000123456789123456789123456789 correctly', () => {
            expect(
              formatDisplayNumber('0.00000000000000000000000123456789123456789123456789', { significantDigits: 18 }),
  ...
  describe('Price', () => {
    ...
    test('format Price 1/123456789 correctly', () => {
      expect(
        formatDisplayNumber(
          new Price({
    ...
    test('format Price 12/123456789 correctly', () => {
      expect(
        formatDisplayNumber(
          new Price({
    ...
    test('format Price 123/123456789 correctly', () => {
      expect(
        formatDisplayNumber(
          new Price({
    ...
    test('format Price 1234/123456789 correctly', () => {
      expect(
        formatDisplayNumber(
          new Price({
    ...
    test('format Price 12345/123456789 correctly', () => {
      expect(
        formatDisplayNumber(
          new Price({
    ...
    test('format Price 123456/123456789 correctly', () => {
      expect(
        formatDisplayNumber(
          new Price({
    ...
    test('format Price 1234567/123456789 correctly', () => {
      expect(
        formatDisplayNumber(
          new Price({
    ...
    test('format Price 12345678/123456789 correctly', () => {
      expect(
        formatDisplayNumber(
          new Price({
    ...
    test('format Price 123456789/123456789 correctly', () => {
      expect(
        formatDisplayNumber(
          new Price({
    ...
    test('format Price 123456789123456789/123456789 correctly', () => {
      expect(
        formatDisplayNumber(
          new Price({
    ...
    test('format Price 123456789123456789/77777 correctly', () => {
      expect(
        formatDisplayNumber(
          new Price({
