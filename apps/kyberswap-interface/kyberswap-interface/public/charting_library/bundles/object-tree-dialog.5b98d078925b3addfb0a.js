  ...
  ['object-tree-dialog'],
  {
    ...
    EqDG: function (e, t, n) {
      ...
      var r = n('aKzv'),
        ...
        u = 'dnd-core/END_DRAG'
      function l(e, t) {
        return { type: o, payload: { sourceClientOffset: t || null, clientOffset: e || null } }
      }
      function d(e) {
        return (d =
      ...
      var v = { type: o, payload: { clientOffset: null, sourceClientOffset: null } }
      function b(e) {
        return function () {
      ...
      function y(e) {
        Object(r.a)('function' == typeof e, 'When clientOffset is provided, getSourceClientOffset must be a function.')
      }
      function O(e) {
      ...
      function C(e) {
        return function (t) {
          ...
          E(o, i, s)
          var c = i.getItemType()
          return j(o, s, c), D(o, i, s), { type: a, payload: { targetIds: o, clientOffset: r || null } }
        }
      }
      function T(e) {
      ...
      function E(e, t, n) {
        ...
        for (var o = 0; o < e.length; o++) {
          var i = e[o]
          Object(r.a)(e.lastIndexOf(i) === o, 'Expected targetIds to be unique in the passed array.')
          var s = n.getTarget(i)
      ...
      function N(e) {
        Object(r.a)(e.isDragging(), 'Cannot call drop while not dragging.'),
          Object(r.a)(!e.didDrop(), 'Cannot call drop twice during one drag operation.')
      }
      function P(e, t, n, o) {
        var i = n.getTarget(e),
        ...
        return (
          (function (e) {
            Object(r.a)(void 0 === e || p(e), 'Drop result must either be an object or undefined.')
          })(s),
      ...
      function L(e) {
        return function () {
          var t = e.getMonitor(),
            n = e.getRegistry()
          !(function (e) {
            Object(r.a)(e.isDragging(), 'Cannot call endDrag while not dragging.')
          })(t)
          var o = t.getSourceId()
              ...
              },
              {
                ...
                value: function () {
                  var e = this,
                    ...
                    n = (function (e) {
                      return { beginDrag: b(e), publishDragSource: w(e), hover: C(e), drop: x(e), endDrag: L(e) }
                    })(this)
      ...
      function q() {
        ...
        switch (t.type) {
          ...
          case a:
            return z(e.clientOffset, n.clientOffset) ? e : V(V({}, e), {}, { clientOffset: n.clientOffset })
          case u:
          case c:
            return W
          default:
      ...
      function ne() {
        ...
        switch (t.type) {
          ...
          case c:
            return $($({}, e), {}, { dropResult: n.dropResult, didDrop: !0, targetIds: [] })
          case u:
            return $(
              $({}, e),
              {},
      ...
      function he() {
        ...
        return {
          dirtyHandlerIds: ae(e.dirtyHandlerIds, {
            type: t.type,
            payload: le(le({}, t.payload), {}, { prevTargetIds: h(e, 'dragOperation.targetIds', []) }),
          }),
            ...
            (n = [
              {
                ...
                value: function (e) {
                  var t = this,
                    ...
                    o = n.handlerIds
                  Object(r.a)('function' == typeof e, 'listener must be a function.'),
                    Object(r.a)(
                  ...
                  var i = this.store.getState().stateId,
                    s = function () {
                      var n = t.store.getState(),
                        r = n.stateId
                      try {
                        r === i || (r === i + 1 && !se(n.dirtyHandlerIds, o)) || e()
                      } finally {
                        i = r
                      }
                    }
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return (
                    Object(r.a)(t, 'Expected to find a valid source. sourceId='.concat(e)),
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return (
                    Object(r.a)(t, 'Expected to find a valid target. targetId='.concat(e)),
              ...
              },
              {
                ...
                value: function () {
                  return (
                    ...
                    r && o && i ? fe(((n = i), { x: (t = r).x + n.x, y: t.y + n.y }), o) : null
                  )
                  var e, t, n, r, o, i
                },
              },
          ...
          (n = [
            {
              ...
              value: function (e, t) {
                ye(e),
                  (function (e) {
                    Object(r.a)('function' == typeof e.canDrag, 'Expected canDrag to be a function.'),
                      Object(r.a)('function' == typeof e.beginDrag, 'Expected beginDrag to be a function.'),
                      Object(r.a)('function' == typeof e.endDrag, 'Expected endDrag to be a function.')
                  })(t)
            ...
            },
            {
              ...
              value: function (e, t) {
                ye(e, !0),
                  (function (e) {
                    Object(r.a)('function' == typeof e.canDrop, 'Expected canDrop to be a function.'),
                      Object(r.a)('function' == typeof e.hover, 'Expected hover to be a function.'),
                      Object(r.a)('function' == typeof e.drop, 'Expected beginDrag to be a function.')
                  })(t)
            ...
            },
            {
              key: 'getTarget',
              value: function (e) {
                return Object(r.a)(this.isTargetId(e), 'Expected a valid target ID.'), this.dropTargets.get(e)
              },
            },
            {
              key: 'getSourceType',
              value: function (e) {
                return Object(r.a)(this.isSourceId(e), 'Expected a valid source ID.'), this.types.get(e)
              },
            },
            {
              key: 'getTargetType',
              value: function (e) {
                return Object(r.a)(this.isTargetId(e), 'Expected a valid target ID.'), this.types.get(e)
              },
            },
            {
              key: 'isSourceId',
            ...
            },
            {
              ...
              value: function (e) {
                ...
                Object(r.a)(t, 'Expected an existing source.'), (this.pinnedSourceId = e), (this.pinnedSource = t)
              },
            },
            {
              key: 'unpinSource',
              value: function () {
                Object(r.a)(this.pinnedSource, 'No source is pinned at the time.'),
                  (this.pinnedSourceId = null),
                  (this.pinnedSource = null)
              },
            },
            {
              ...
              value: function (e, t, n) {
                ...
                return (
                  this.types.set(r, t),
                  e === ge.SOURCE ? this.dragSources.set(r, n) : e === ge.TARGET && this.dropTargets.set(r, n),
                  r
                )
              },
            },
      ...
      function Ie(e) {
        ...
        return Object(F.e)(he, e && t && t({ name: 'dnd-core', instanceId: 'dnd-core' }))
      }
      n.d(t, 'a', function () {
        return De
      })
    ...
    FadI: function (e, t, n) {
      ...
      function o(e) {
        return (null == e ? void 0 : e.aborted)
          ? Promise.reject(i())
          : new Promise((t, n) => {
              null == e || e.addEventListener('abort', () => n(i()), { once: !0 })
            })
      }
      function i() {
        ...
        var l = 0,
          ...
          h = Object(o.memo)(function (e) {
                ...
                (function (e) {
                  ...
                  var t = (function (e) {
                      var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : f(),
                        ...
                        o = t
                      o[d] || (o[d] = { dragDropManager: Object(i.a)(e, t, n, r) })
                      return o[d]
            ...
            return (
              ...
              Object(r.jsx)(s.a.Provider, Object.assign({ value: c }, { children: t }), void 0)
            )
          })
        function f() {
        ...
        return o.a.createElement(
          ...
          o.a.createElement(
            ...
            o.a.createElement(
              ...
              n && o.a.createElement('div', { className: a()(O.ellipsis, O.subtitle) }, n),
            ),
            u,
            i &&
              !f &&
          ...
          return o.a.createElement(f.a, { rule: h.a.SmallHeight }, c =>
            o.a.createElement(f.a, { rule: h.a.TabletSmall }, u =>
              o.a.createElement(
                ...
                o.a.createElement(
                  'div',
                  { className: w.wrapper, 'data-name': i, 'data-dialog-name': 'string' == typeof r ? r : '' },
                  void 0 !== r &&
                    o.a.createElement(S, {
                      draggable: y && !(u || O),
    ...
    'p0W+': function (e, t, n) {
      ...
      const a = r.forwardRef((e, t) => {
        ...
        return r.createElement(i.b, { ...a, ref: t, className: o(n, s.button) })
      })
    },
    px1m: function (e, t, n) {
      e.exports = {
    ...
    xNz2: function (e, t, n) {
      ...
      var A = n('p0W+'),
        ...
        H = n('JWMC')
      function z(e) {
        const { viewModel: t } = Object(j.ensureNotNull)(Object(o.useContext)(P)),
          n = Object(N.a)(),
          r = t.selection()
        Object(o.useEffect)(() => {
          const e = {}
        ...
        return i.a.createElement(
          i.a.Fragment,
          null,
          i.a.createElement('div', { className: D(F.title, F.withoutIcon) }, Object(y.t)('Object tree'), !1),
          i.a.createElement(
            'div',
            { className: F.buttons },
      ...
      var J = (function () {
        function e(t, n) {
          ...
          for (var s, a, c = [], u = [], l = [], d = 0; d < r - 1; d++)
            (s = t[d + 1] - t[d]), (a = n[d + 1] - n[d]), u.push(s), c.push(a), l.push(a / s)
      ...
      function $(e, t, n, r, o) {
        var i,
          ...
          c =
            'IMG' === (i = t).nodeName &&
            (q() || !(null !== (s = document.documentElement) && void 0 !== s && s.contains(i))),
          u = X(c ? e : t),
          ...
          O = 0 === y || y
        return {
          x: 0 === m || m ? m : new J([0, 0.5, 1], [l.x, (l.x / d) * v, l.x + v - d]).interpolate(f),
          y: O
            ? y
            : ((a = new J([0, 0.5, 1], [l.y, (l.y / h) * b, l.y + b - h]).interpolate(p)),
            ...
            (n = [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return pe({ dropEffect: this.altKeyPressed ? 'copy' : 'move' }, t || {})
                },
              },
              {
      ...
      var xe =
          ...
          Me(De, be.touch, { start: 'touchstart', move: 'touchmove', end: 'touchend' }),
          ...
          function e(t, n, r) {
            ...
            !(function (e, t) {
              ...
              (this.handleTopMoveStart = function (e) {
                if (_e(e)) {
                  var t = Te(e)
                  t && (Ce(e) && (o.lastTargetTouchFallback = e.targetTouches[0]), (o._mouseClientOffset = t)),
                    (o.waitingForDelay = !1)
                }
              }),
              ...
              (this._isScrolling = !1),
              this.options.enableMouseEvents && this.listenerTypes.push(be.mouse),
              this.options.enableTouchEvents && this.listenerTypes.push(be.touch),
              this.options.enableKeyboardEvents && this.listenerTypes.push(be.keyboard)
          }
          var t, n, r
          return (
            (t = e),
            (n = [
              ...
              },
              {
                ...
                value: function () {
                  this.document &&
                    (Object(Oe.a)(!e.isSetUp, 'Cannot have two Touch backends at the same time.'),
                    (e.isSetUp = !0),
      ...
      const Ct = e => e.nodes,
        ...
        Nt = Object(_t.a)([e => e.disabled, Tt, It], (e, t, n) => !t.ids.includes(n) && e.includes(n)),
        ...
        Ft = Object(_t.a)(Ct, e => Object.values(e).filter(e => 0 === e.level)),
        Ht = Object(_t.a)([Ct, Ft], (e, t) => t.reduce((t, n) => [...t, ...zt(e, Object(j.ensureDefined)(n))], []))
      function zt(e, t) {
        const n = []
      ...
      const Ut = Object(_t.a)([Ct, Ft, jt], (e, t, n) => {
          const r = new Set(n)
          return t.reduce((t, n) => [...t, ...Vt(e, Object(j.ensureDefined)(n), r)], [])
        }),
      ...
      function* Kt(e) {
        ...
        yield Object(T.e)((e => ({ type: Be, nodes: e }))(r)), yield Object(T.e)(ft(t))
        !Lt(yield Object(T.f)()) && t.length > 0 && (yield Object(T.e)(bt(t[0])), yield Object(T.e)(mt(t[0])))
      }
      function* Wt(e) {
        for (;;) {
      ...
      function* Yt(e, t) {
        for (;;) {
          const { type: n } = yield Object(T.g)([We, Ke]),
            ...
            c = en(r, a, o, s),
            { id: u } = c
          e ? e([u], a) : yield Object(T.e)(ft([u])), t && t(u), yield Object(T.e)(bt(u))
        }
      }
      function* Zt(e, t = () => !0) {
        for (;;) {
      ...
      function* Jt(e = () => !0, t) {
        ...
        l.map(e => e.id).includes(d.id)
          ...
          : h &&
            e(l, d, r) &&
            (yield Object(T.e)(((e, t, n) => ({ type: Je, node: e, dropType: t, boundBox: n }))(d, r, i)))
      }
      function* Xt(e) {
      ...
      function en(e, t, n, r) {
        ...
        let i,
          s = 0
        for (; !i || (Math.abs(s) < o && (a = i).level > 1 && !xt(e, Object(j.ensureDefined)(a.parentId))); )
      ...
      function* tn(e = {}) {
        const {
          ...
          u = [Object(T.d)(Xt, r), Object(T.d)(Qt, n), Object(T.d)(Zt, i, c), Object(T.d)(Yt, i, s), Object(T.d)(qt)]
        for (t && u.push(Object(T.d)(t)), o && u.push(Object(T.d)($t, o)), c && u.push(Object(T.d)(Wt, c)); ; ) {
            ...
            (n = [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  try {
                    return (hn = !0), this.internalMonitor.canDropOnTarget(this.targetId)
                  } finally {
                    hn = !1
                  }
                },
      ...
      function On(e) {
        return null !== e && 'object' === yn(e) && Object.prototype.hasOwnProperty.call(e, 'current')
      }
      function Sn(e, t) {
        for (var n = 0; n < t.length; n++) {
          var r = t[n]
        ...
        return (
          ...
          (n = [
            ...
            },
            {
              ...
              value: function () {
                return !pn(this.lastConnectedDropTargetOptions, this.dropTargetOptions)
              },
            },
            {
      ...
      function Yn(e) {
            ...
            return (
              ...
              (a = [
                ...
                },
                {
                  ...
                  value: function (e) {
                    if (this.handlerMonitor && this.manager && this.handlerConnector && e !== this.currentType) {
                      ...
                      this.disposable.setDisposable(new Ln(new An(o), new An(r)))
                    }
                  },
                },
                {
                ...
                },
                {
                  key: 'getCurrentState',
                  value: function () {
                    return this.handlerConnector ? u(this.handlerConnector.hooks, this.handlerMonitor, this.props) : {}
                  },
                },
                {
                  key: 'render',
                      ...
                      Mn.a.Consumer,
                      {
                        children: function (t) {
                          ...
                          return (
                            ...
                            Object(kn.jsx)(
                              h,
                              Object.assign({}, e.props, e.getCurrentState(), { ref: Tn(h) ? e.decoratedRef : null }),
                              void 0,
                            )
                          )
                        },
        ...
        return (p.DecoratedComponent = t), (p.displayName = ''.concat(a, '(').concat(f, ')')), Fn()(p, t)
      }
      function Zn(e, t) {
        for (var n = 0; n < t.length; n++) {
          var r = t[n]
          ...
          return (
            ...
            (n = [
              ...
              },
              {
                key: 'hover',
                value: function () {
                  this.spec.hover && this.props && this.spec.hover(this.props, this.monitor, Cn(this.ref))
                },
              },
              {
                key: 'drop',
        ...
        return (
          ...
          (n = [
            ...
            },
            {
              ...
              value: function () {
                return !pn(this.lastConnectedDragSourceOptions, this.dragSourceOptions)
              },
            },
            {
              key: 'didDragPreviewOptionsChange',
              value: function () {
                return !pn(this.lastConnectedDragPreviewOptions, this.dragPreviewOptions)
              },
            },
            {
            ...
            (n = [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  try {
                    return (ir = !0), this.internalMonitor.canDragSource(this.sourceId)
                  } finally {
                    ir = !1
                  }
                },
              },
              {
                ...
                value: function () {
                  ...
                  try {
                    return (sr = !0), this.internalMonitor.isDraggingSource(this.sourceId)
                  } finally {
                    sr = !1
                  }
                },
          ...
          return (
            ...
            (n = [
              ...
              },
              {
                key: 'endDrag',
                value: function () {
                  this.props && this.spec.endDrag && this.spec.endDrag(this.props, this.monitor, Cn(this.ref))
                },
              },
            ]) && cr(t.prototype, n),
            r && cr(t, r),
      ...
      class wr extends i.a.PureComponent {
        ...
        render() {
          return i.a.createElement(_r, { ...this.props, reference: this._handleRef })
        }
        getNode() {
      ...
      const _r = e => {
          ...
          let [w, _] = Object(vr.c)()
          return (
            tr.CheckMobile.any() && ((w = n), (_ = { onMouseOut: Sr, onMouseOver: Sr })),
            i.a.createElement(
              'div',
              {
                className: D(Or.wrap, n && Or.selected, b && Or.childOfSelected, c && Or.disabled, s && Or.expandable),
                onClick:
                  1 === m && 0 === y
                    ? C
                    : function (e) {
      ...
      function zr(e) {
        ...
        return (
          ...
          function (n) {
                              ...
                              return void 0 === n
                                ...
                                : (e.receiveDragDropManager(n),
                                  e.isCurrentlyMounted
                                    ? Object(kn.jsx)(
                                        r,
                                        Object.assign({}, e.props, e.state, { ref: Tn(r) ? e.ref : null }),
                                        void 0,
                                      )
                                    : null)
                            },
            ...
            return (c.displayName = 'DragLayer('.concat(a, ')')), (c.DecoratedComponent = n), Fn()(c, n)
          }
        )
      }
      var Ur = n('AiMB')
      ...
      const Wr = zr(function (e) {
        ...
        Object(G.b)(
          ...
          const { items: t, isDragging: n, nodeRenderer: r, dragPreviewRenderer: o } = e
          return Gr(function () {
            return n
              ? i.a.createElement(
                  Ur.a,
      ...
      const Zr = i.a.forwardRef((e, t) => {
          ...
          return (
            ...
            Object(o.useImperativeHandle)(t, () => ({ getNode: () => Object(j.ensureNotNull)(n.current) }), []),
            ...
            hover: (e, t, n) => {
              ...
              if ('last' === e.type) {
                const t = r.x - i.left < 48,
                  n = o[o.length - 1],
                  a = t && 2 === n.level ? Object(j.ensureDefined)(o.find(e => e.id === n.parentId)) : n,
                  c = {
                    top: i.top - s.top,
                    left: i.left - s.left,
                    bottom: i.top - s.top,
      ...
      const eo = zr(function (e) {
          ...
          Object(G.b)(
            ...
            const { dropType: t, boundBox: n, isDragging: r, level: i, transform: s = $r } = e
            return Gr(function () {
              if (!r || !t || !n) return null
              const a = { [Qr.dropTarget]: 'inside' !== t, [Qr.dropTargetInside]: 'inside' === t },
                { width: c, height: u } = n,
                [l, d] = s(e),
      ...
      const so = i.a.forwardRef(function (e, t) {
          ...
          Object(o.useEffect)(() => {
            const e = e => {
                ;[pr.Modifiers.Mod, pr.Modifiers.Shift].includes(Object(pr.modifiersFromEvent)(e)) && a()
              },
              t = e => {
                c && ![pr.Modifiers.Mod, pr.Modifiers.Shift].includes(Object(pr.modifiersFromEvent)(e)) && s()
              }
            return (
                  ...
                  const n = Object(j.ensureNotNull)(e.current),
                    r = e => {
                      if (e.target instanceof Element) {
                        const n = Object(j.ensureNotNull)(e.target.closest('[draggable]'))
          ...
          const x = Object(o.useCallback)(() => Object(j.ensureNotNull)(W.current), []),
              ...
              for (let o = 0; o < r.length; o++) {
                ...
                1 === s.level &&
                  (void 0 !== n &&
                    ...
                    t.push({
                      type: 'separator',
                      node: i.a.createElement('div', { key: n + '_separator', className: ro.separator }),
                    }),
                  (n = s.parentId)),
                  t.push({
                    type: 'node',
          ...
          const R = Object(o.useCallback)(e => {
            ...
            F = Object(o.useCallback)(e => Object(j.ensure)(L.current[e].node.key), []),
            H = Object(o.useMemo)(
              () => (null === b ? { index: -1 } : { index: L.current.findIndex(e => e.node.key === b.id) }),
              [b],
            )
          h(M)
          const [z, U, G, V] = Object(Yr.a)(),
            K = Object(o.useRef)(null)
          Object(o.useEffect)(() => Object(j.ensureNotNull)(K.current).resetAfterIndex(0, !0), [A]),
            Object(o.useEffect)(() => Object(j.ensureNotNull)(K.current).scrollToItem(H.index), [H])
          const W = Object(o.useRef)(null),
            ...
            Z = Object(o.useRef)({
              startScroll(e) {
                const t = () => {
                  null !== G.current && ((Y.current = requestAnimationFrame(t)), G.current.scrollBy({ top: e }))
                }
                this.stopScroll(), t()
              },
              stopScroll() {
          ...
          return (
            ...
            i.a.createElement(
              ...
              i.a.createElement(
                ...
                i.a.createElement(qr.a, { ...z, className: ro.overlayScrollWrap }),
                ...
                i.a.createElement(Wr, { dragPreviewRenderer: l, nodeRenderer: u }),
              ),
            )
          )
        }),
        ao = $n(
          ...
          {
            drop: (e, t, n) => {
              ;('touch' === e.drag || tr.isFF) && n.stopScroll(), t.getItem().dropSelection()
            },
            hover: (e, t, n) => {
      ...
      function lo(e) {
        ...
        return (
          ...
          Object(o.useEffect)(
            () => (
              null !== b && u && (p && (p.current = performance.now()), b.dispatch((e => ({ type: Fe, nodes: e }))(u))),
              () => {}
            ),
            [b, u],
          ),
          ...
          null === b ? null : i.a.createElement(ho, { store: b, scrollToId: g, ...v })
        )
      }
      const ho = i.a.memo(function (e) {
        ...
        return (
          Object(o.useEffect)(() => {
            var e
            t.dispatch(mt(null !== (e = null == n ? void 0 : n.id) && void 0 !== e ? e : null))
          }, [n]),
          i.a.createElement(
            Ae.a,
            { backend: s, options: uo },
            i.a.createElement(G.a, { store: t, context: Cr }, i.a.createElement(co, { ...r })),
          )
        )
      })
      function fo(e, t) {
      ...
      function* bo() {
        for (;;) {
          ...
          1 === e && fo('Multi select', 'Ctrl'), 2 === e && fo('Multi select', 'Shift')
        }
      }
      function* mo(e) {
        for (;;) {
      ...
      function No(e) {
        ...
        return i.a.createElement(k.a, { className: I()(xo.button, n && xo.disabled, t), ...r })
      }
      var Po = n('To8B'),
        Ao = n('tyJc'),
        Lo = n('20cQ'),
      ...
      function zo(e) {
        ...
        Object(o.useEffect)(() => {
          ...
          return (
            ...
            l.onIsActualIntervalChange().subscribe(e, () => E(l.isActualInterval())),
            () => {
          ...
          Object(o.useEffect)(() => {
            g && b.current && (b.current.focus(), b.current.setSelectionRange(0, m.length))
          }, [g]),
          Object(o.useEffect)(() => {
            const e = {}
            return (
          ...
          Object(o.useEffect)(() => {
            !s && A.current && (clearTimeout(A.current), (A.current = null)), v(!1)
          }, [s])
        ...
        const H = ko.enabled('test_show_object_tree_debug') ? `<${l.id()}> (${l.zOrder()})` : l.title(),
          z = c || I,
          U = g && s,
          G = !!f && f.isTouch,
          V = !!f && f.isDialog,
        ...
        return i.a.createElement(
          'span',
          {
            ...
            onMouseDown: function (e) {
              g && !Object(j.ensureNotNull)(b.current).contains(e.target) && N(!0)
            },
            onClick:
              1 === p
                ? q
                : function (e) {
                    ...
                    if (A.current)
                      e.preventDefault(), clearTimeout(A.current), (A.current = null), L.openProperties(l), N(!1)
                    else {
                      const e = L.selection().selected()
                      A.current = setTimeout(() => {
                        ;(A.current = null), s && !x && 1 === e.length && L.rename(l, () => v(!0)), N(!1)
                      }, 500)
                    }
                  },
          ...
          !U &&
            i.a.createElement(
              o.Fragment,
              null,
              B && B.type === Io.Svg && i.a.createElement(k.a, { icon: B.content || '', className: Fo.icon }),
              B && B.type === Io.Text && i.a.createElement('span', { className: D(Fo.icon, Fo.textIcon) }, B.content),
              i.a.createElement(
                'span',
                { className: D(Fo.title, L.isMain(l) && Fo.main, (!l.isVisible() || !T) && Fo.disabled), ...F },
                H,
              ),
              (z || S || !_ || G || !T) &&
                i.a.createElement(
                  ...
                  (z || !_ || !T) &&
                    i.a.createElement(No, {
                      icon: K,
                      className: D(Fo.button, Fo.viewButton, !T && [Fo.warn, 'apply-common-tooltip']),
                      onClick: T
                        ? function (e) {
                            if (e.defaultPrevented) return
                            e.preventDefault(), L.setIsVisible(t, !l.isVisible())
                          }
                        : void 0,
                      title: T ? void 0 : W,
                      disabled: !T,
            ...
            i.a.createElement(Mo.a, {
              ...
              onKeyDown: function (e) {
                27 === Object(pr.hashFromEvent)(e)
                  ...
                  : 13 === Object(pr.hashFromEvent)(e) && (e.preventDefault(), Y())
              },
        ...
        function q(e) {
          e.defaultPrevented || g || (e.preventDefault(), e.persist(), L.openContextMenu(l, () => v(!0), e))
        }
        function Y() {
      ...
      class Go extends i.a.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._renderChildren = e => i.a.createElement(Vo, { isSmallTablet: e, viewModel: this.props.viewModel })),
            (this._handleMediaChange = () => {
              this.state.showDrawer && !window.matchMedia(S.a.TabletSmall).matches && this.setState({ showDrawer: !1 })
            }),
      ...
      function Vo(e) {
        const { isSmallTablet: t, viewModel: n } = e,
          r = Object(o.useMemo)(() => ({ size: t ? 1 : 0, smallSizeTreeNodeAction: 0 }), [t])
        return i.a.createElement(
          br.Provider,
          { value: r },
          i.a.createElement(jo, { nodeRenderer: Ho, showHeader: !1, viewModel: n, isDialog: !0 }),
        )
      }
      var Ko = n('eqEH'),
        Wo = n('vPbs'),
      ...
      class Qo {
        constructor(e) {
          ;(this._onChange = new Yo.a()),
            (this._recalculate = () => {
              const e = this._groupModel.groups().map(e => Xo(e.id, e.instanceId)),
        ...
        set(e) {
          ...
          for (const r of e)
            if (r.hasChildren()) {
              ...
              t.push(...Array.from(e.values()).map(Zo)), (n = n.filter(t => !e.has(t)))
            } else t.push(r.id())
        ...
        buildTree() {
          ...
          for (const t of this._controller.model().panes()) {
            ...
            for (const n of this._groupModel.groups()) {
              ...
              if (o.pane() === t) {
                const r = [...n.lineTools()].sort((e, t) => (e.zorder() > t.zorder() ? -1 : 1)).map(e => e.id())
                ;(e[o.id()] = ei(o.id(), 1, t.id(), r)), e[t.id()].children.push(o.id())
                for (const t of r) e[t] = ei(t, 2, o.id())
              }
            }
            for (const r of n) e[r.id()] || ((e[r.id()] = ei(r.id(), 1, t.id())), e[t.id()].children.push(r.id()))
            e[t.id()].children.sort((e, t) => {
              ...
              return Object(j.ensureNotNull)(r.zOrder()) - Object(j.ensureNotNull)(n.zOrder())
            })
          }
      ...
      function pi(e) {
        return e instanceof ri.DataSource && e.showInObjectTree() ? e.id() : null
      }
      const gi = new Yo.a()
      class vi {
        constructor(e, t) {
          ;(this._syncStateChanged = new Yo.a()),
            ...
            (this._undoModel = e),
            (this._dataSource = t),
            Object(ti.isLineTool)(this._dataSource) && this._dataSource.linkKey().subscribe(this._linkKeyChangedBound)
        }
        destroy() {
          Object(ti.isLineTool)(this._dataSource) && this._dataSource.linkKey().unsubscribe(this._linkKeyChangedBound)
        }
        id() {
        ...
        canBeLocked() {
          return Object(ti.isLineTool)(this._dataSource) && this._dataSource.userEditEnabled()
        }
        canBeRemoved() {
        ...
        isActualInterval() {
          return (
            (!Object(ti.isLineTool)(this._dataSource) && !Object(ni.isStudy)(this._dataSource)) ||
            this._dataSource.isActualInterval()
          )
        }
        onIsActualIntervalChange() {
          return Object(ti.isLineTool)(this._dataSource) || Object(ni.isStudy)(this._dataSource)
            ? this._dataSource.onIsActualIntervalChange()
            : gi
        }
        isLocked() {
          return !!Object(ti.isLineTool)(this._dataSource) && this._dataSource.properties().frozen.value()
        }
        onVisibilityChanged() {
          return this._dataSource.properties().visible.listeners()
        }
        onLockChanged() {
          return Object(ti.isLineTool)(this._dataSource) ? this._dataSource.properties().frozen.listeners() : gi
        }
        getIcon() {
          const e = d,
          ...
          if (e && t)
            ...
            } else 'text' === t.type && (r = { type: Io.Text, content: t.text })
          return r
        }
        setVisible(e) {
          const t = (e ? ci : ui).format({ sourceTitle: this._dataSource.title() })
          this._undoModel.setProperty(this._dataSource.properties().visible, e, t)
        }
        setLocked(e) {
          if (Object(ti.isLineTool)(this._dataSource)) {
            const t = (e ? li : di).format({ sourceTitle: this._dataSource.translatedType() })
        ...
        pane() {
          return Object(j.ensureNotNull)(this._undoModel.model().paneForSource(this._dataSource))
        }
        ...
        canBeSyncedInLayout() {
          return Object(ti.isLineTool)(this._dataSource) && this._dataSource.isSynchronizable()
        }
        onSyncStateChanged() {
        ...
        getDrawingSyncState() {
          return this.canBeSyncedInLayout() ? (null !== this._dataSource.linkKey().value() ? 1 : 0) : null
        }
        _linkKeyChanged() {
          this._syncStateChanged.fire(Object(j.ensureNotNull)(this.getDrawingSyncState()))
        }
          ...
          if (Object(ti.isLineTool)(this._dataSource)) {
            ...
            null !== t
              ? (Object(j.assert)(!e.some(e => e.hasChildren())),
                i.forEach(e => {
                  Object(ti.isLineTool)(e) && (t.containsLineTool(e) || r.addLineToolToGroup(t, e))
                }))
              : o()
          } else o()
      ...
      class bi {
        constructor(e, t) {
          ;(this._onTitleChanged = new Yo.a()),
            ...
            (this._paneId = Object(j.ensureNotNull)(e.model().paneForSource(this._lineTools[0])).id())
          const n = () => {
            this._lineTools.forEach(e => {
              ...
              this._lineTools.length > 0 && this._lineTools[0].linkKey().subscribe(this._linkKeyChangedBound)
          }
        ...
        childrenIds() {
          ...
          return e.sort((e, t) => t.zorder() - e.zorder()), new Set(e.map(e => e.id()))
        }
        hasChildren() {
          return !0
        }
        ...
        _unsubscribeFromAllLineTools() {
          this._lineTools.forEach(e => {
            ...
            this._lineTools.length > 0 && this._lineTools[0].linkKey().unsubscribe(this._linkKeyChangedBound)
        }
      }
      class mi {
        constructor(e) {
        ...
        getObjectById(e) {
          if (this._entitiesCache.has(e)) return Object(j.ensureDefined)(this._entitiesCache.get(e))
        ...
        canBeGroupped(e) {
          ...
          const t = []
          if ((e.forEach(e => e.addSourcesToArray(t)), t.some(e => !Object(ti.isLineTool)(e)))) return !1
          const n = this._undoModel.model(),
      ...
      class xi {
        constructor(e) {
          ;(this._nodes = {}),
            ...
            (this._ensuredEntity = e => Object(j.ensureNotNull)(this._getEntityById(e))),
            (this._chart = e),
            this._init()
        }
        destroy() {
        ...
        canNodeWithIdBeUnmerged(e) {
          const t = this._model.dataSourceForId(e)
          return null !== t && Mi(t) && this._model.isUnmergeAvailableForSource(t)
        }
        unmergeSelectionUp() {
        ...
        copySelection() {
          const e = this._getSelectedEntities(),
            t = e.map(e => Object(j.ensureNotNull)(this._model.dataSourceForId(e.id())))
          this._chart.value().chartWidgetCollection().clipboard.uiRequestCopy(t), fo('Copy', po(e))
        }
        cloneSelection() {
          const e = this._getSelectedEntities(),
            t = e.map(e => Object(j.ensureNotNull)(this._model.dataSourceForId(e.id())))
          t.every(ti.isLineTool) && (this._controller.cloneLineTools([...t], !1), fo('Clone', po(e)))
        }
        rename(e, t) {
          const n = this._getObjectsToModify(e.id())
          1 === n.length && n.some(e => e.canBeRenamed()) && (t(), fo('Rename', po(n)))
        }
        async openContextMenu(e, t, n) {
          ...
          if (this._objects.some(e => e.hasChildren())) o = this._getActionsForGroupItem(e, t, r)
            ...
            if (
              ((o = Array.from(e).filter(
                (e, t, n) => e.type !== Si.a.Separator || !n[t + 1] || n[t + 1].type !== Si.a.Separator,
              )),
          ...
          o.length > 0 &&
            ...
            So.ContextMenuManager.createMenu(o, { takeFocus: !0, returnFocus: !0 }, () => {
        ...
        getNextNodeIdAfterRemove(e) {
          ...
          if (
            ...
            return Object(j.ensureDefined)(n.find(e => e.id === t)).children[0]
          }
          const i = Object(j.ensureDefined)(n.find(e => e.id === r.parentId)).children
        ...
        _getActionsForGroupItem(e, t, n) {
          ...
          return (
            1 === this._objects.length && (r.unshift(new Oi.Separator()), r.unshift(this._getRenameAction(t))),
            n && (r.unshift(new Oi.Separator()), r.unshift(this._getGroupAction())),
            r
          )
        }
        _unmergeSelection(e) {
        ...
        _getSelectedEntities() {
          ...
          return (
            t.length &&
              ki.logWarn('Detected dangling sources in selection. They will be ignored: ' + JSON.stringify(t)),
            e
          )
        }
        _getEntityById(e) {
      ...
      class Pi extends Ni.a {
        constructor() {
          ...
          ;(this._activeChartWidget = e.activeChartWidget.value()), (this._viewModel = new xi(e.activeChartWidget))
        }
        hide() {
          this._handleClose()
        }
