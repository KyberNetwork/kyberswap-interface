...
const SUMMARY: { [type in TRANSACTION_TYPE]: SummaryFunction } = {
  ...
  [TRANSACTION_TYPE.EARN_VAULT_DEPOSIT]: summary2Token,
  [TRANSACTION_TYPE.EARN_VAULT_WITHDRAW]: summary2Token,
  [TRANSACTION_TYPE.EARN_VAULT_WITHDRAW_REQUEST]: summary1Token,
  [TRANSACTION_TYPE.EARN_VAULT_WITHDRAW_CANCEL]: summaryApprove,
}
