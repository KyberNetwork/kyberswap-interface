...
export const CONNECTION = {
  ...
  HARDCODED_BITGET_CONNECTOR_ID: 'BitgetWallet',
} as const
...
// hardcoded connector to display bitget as a default option. will replace by the real one if user already installed bitget extension
const bigetConnector = () => {
