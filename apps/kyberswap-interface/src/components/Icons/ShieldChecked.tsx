function ShieldChecked({ size, color = '#A9A9A9' }: { size?: number; color?: string }) {
  return (
    <svg width={size || 24} height={size || 24} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
      ...
      />
      <path d="M10.1667 6.75L7.66669 9.25L6.16669 7.75" stroke={color} strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}
