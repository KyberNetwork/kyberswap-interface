...
const DESCRIPTION_MAP: {
  ...
  [TRANSACTION_TYPE.EARN_VAULT_DEPOSIT]: Description2Token,
  [TRANSACTION_TYPE.EARN_VAULT_WITHDRAW]: Description2Token,
  [TRANSACTION_TYPE.EARN_VAULT_WITHDRAW_REQUEST]: Description1Token,
  [TRANSACTION_TYPE.EARN_VAULT_WITHDRAW_CANCEL]: DescriptionApproveClaim,
}
