...
const etherlinkInfo: NetworkInfo = {
  chainId: ChainId.ETHERLINK,
  route: 'etherlink',
  ksSettingRoute: 'etherlink',
  ...
  etherscanUrl: 'https://explorer.etherlink.com',
  etherscanName: 'Etherlink Explorer',
  bridgeURL: 'https://bridge.etherlink.com/tezos',
  nativeToken: {
    symbol: 'XTZ',
    name: 'XTZ',
    logo: 'https://bridge.etherlink.com/static/tokens/XTZ.png',
    decimal: 18,
  },
