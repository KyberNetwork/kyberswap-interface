...
export const SelectNetwork = forwardRef<SelectNetworkRef, SelectNetworkProps>(
  ({ chainIds = [], onSelectNetwork, selectedChainId, tooltipNotSupportChain }, ref) => {
    ...
    const name = !selectedChainId
      ...
      ? NETWORKS_INFO[selectedChainId as ChainId].name
      : NonEvmChainInfo[selectedChainId as NonEvmChain].name
