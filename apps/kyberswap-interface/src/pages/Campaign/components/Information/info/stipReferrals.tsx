...
const ReferralsHowToSection = (): CampaignSectionComponent => (
  <span>
    <Trans>
...
const ReferralsTimelineSection = (): CampaignSectionComponent => (
...
const ReferralsFaqListSection = (): CampaignSectionComponent => {
...
export const referralsInfo: CampaignContent = {
  HowTo: ReferralsHowToSection,
  Timeline: ReferralsTimelineSection,
  Rewards: ReferralsRewardsSection,
  Terms: ReferralsTermsSection,
  Faq: ReferralsFaqListSection,
}
