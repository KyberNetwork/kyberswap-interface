...
const useKemRewards = (props?: UseKemRewardsProps) => {
  ...
  const [claimingSingle, setClaimingSingle] = useState(false)
    ...
    openClaimModal && claimInfo ? (
      <>
        <ClaimModal
          ...
          claiming={claimingSingle || isCurrentClaimPending}
          claimInfo={claimInfo}
          compoundable
          onClaim={handleClaim}
