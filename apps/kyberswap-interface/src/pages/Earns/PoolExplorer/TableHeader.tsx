...
import { SortableHeader, TableCell, TableHeader as TableHeaderComponent } from 'pages/Earns/PoolExplorer/styles'
...
const TableHeader = ({
  ...
  return !upToMedium ? (
    <TableHeaderComponent expandColumn={isFarmingFiltered}>
      ...
      {isFarmingFiltered && (
        <TableCell flexDirection="row" justifyContent="flex-end">
