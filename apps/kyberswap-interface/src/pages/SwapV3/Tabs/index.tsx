...
export const Tab = ({
  ...
  <ButtonEmpty
    className={cn(
      'relative inline-flex w-fit items-center gap-1 whitespace-nowrap rounded-none p-0 text-lg font-medium leading-[normal] hover:no-underline focus:no-underline max-sm:text-sm sm:gap-2',
