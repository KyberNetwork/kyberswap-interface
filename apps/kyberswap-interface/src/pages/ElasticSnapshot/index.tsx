...
import TreasuryGrantAndInstantClaim from 'pages/ElasticSnapshot/components/TreasuryGrantAndInstantClaim'
import Vesting, { VestingInterface } from 'pages/ElasticSnapshot/components/Vesting'
import poolsByCategoriesRaw from 'pages/ElasticSnapshot/data/category.json'
import data from 'pages/ElasticSnapshot/data/data.json'
...
import vestingOptionAPhase2 from 'pages/ElasticSnapshot/data/vesting/optionA_phase2.json'
import vestingOptionB from 'pages/ElasticSnapshot/data/vesting/optionB.json'
import vestingOptionBPhase2 from 'pages/ElasticSnapshot/data/vesting/optionB_phase2.json'
