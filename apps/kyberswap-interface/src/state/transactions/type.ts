...
export enum TRANSACTION_TYPE {
  ...
  EARN_VAULT_DEPOSIT = 'Deposit to Vault',
  EARN_VAULT_WITHDRAW = 'Withdraw from Vault',
  EARN_VAULT_WITHDRAW_REQUEST = 'Request Vault Withdrawal',
  EARN_VAULT_WITHDRAW_CANCEL = 'Cancel Vault Withdrawal',
}
