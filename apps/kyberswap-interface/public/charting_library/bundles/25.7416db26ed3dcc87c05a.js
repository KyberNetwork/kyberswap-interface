  ...
  [25],
  {
      ...
      function l(e) {
        ...
        for (; (r = i.exec(e)); ) {
          ...
          for (let a = n.length; a--; )
            if (r[a + 1]) {
              n[a] && t.push({ value: r[a + 1], type: n[a], precedence: 0, offset: r.index }), (e = !0)
              break
            }
    ...
    FadI: function (e, t, n) {
      ...
      function a(e) {
        return (null == e ? void 0 : e.aborted)
          ? Promise.reject(o())
          : new Promise((t, n) => {
              null == e || e.addEventListener('abort', () => n(o()), { once: !0 })
            })
      }
      function o() {
    ...
    'ML8+': function (e, t, n) {
      ...
      function i(e) {
        ...
        return r.createElement(o.a, { className: a(n, c.icon, { [c.dropped]: t }), icon: s })
      }
    },
    OWoh: function (e, t) {
      e.exports =
    ...
    UEVQ: function (e, t, n) {
      e.exports = { bubbles: 'bubbles-1cEBkyVM', multiLine: 'multiLine-1cEBkyVM', bubble: 'bubble-1cEBkyVM' }
    },
    UN6M: function (e, t, n) {
          ...
          if ('whitespace' !== o.type) {
            if ('incompleteSymbol' === o.type || 'incompleteNumber' === o.type) {
              const n = r !== e.length - 1,
                a = { status: n ? 'error' : 'incomplete', reason: 'incomplete_token', offset: o.offset, token: o }
            ...
            switch (o.type) {
              ...
              case 'number':
                if ('var' === n) {
                  t.errors.push({ status: 'error', reason: 'unexpected_token', offset: o.offset, token: o })
                  continue
                }
                n = 'var'
                break
              ...
              case 'closeBrace':
                ...
                a.pop() || t.errors.push({ status: 'error', reason: 'unbalanced_brace', offset: o.offset, token: o }),
                  (n = 'var')
                break
              case 'unparsed':
                t.errors.push({ status: 'error', reason: 'unparsed_entity', offset: o.offset, token: o })
            }
          }
        }
        for (
          t.braceBalance = a.length, 'var' !== n && t.warnings.push({ status: 'incomplete', token: e[e.length - 1] });
          a.length;
            ...
            case 'closeBrace': {
              ...
              ;(!l(null == c ? void 0 : c.type) || (null == c ? void 0 : c.precedence) <= r.minPrecedence) &&
                (!l(null == o ? void 0 : o.type) ||
                  ...
                  ((null == o ? void 0 : o.precedence) === (null == r ? void 0 : r.minPrecedence) && s)) &&
    ...
    rzV7: function (e, t, n) {
      ...
      e.exports = function (e, t) {
        ...
        for (var c = 0; c < n.length; c++) if (!r.call(t, n[c]) || !a(e[n[c]], t[n[c]])) return !1
        return !0
      }
    },
    tU7i: function (e, t, n) {
          ...
          const {
            ...
            O =
              ...
              ('string' == typeof n
                ...
                : r.cloneElement(n, { className: a(b.icon, n.props.className) }))
          return r.createElement(
            'div',
            { ...E, ref: t, 'data-role': 'button', className: x, onClick: l ? void 0 : p, title: h, 'data-name': y },
            f && m && r.createElement('div', { className: a('js-button-text', b.text) }, m),
            O,
            !f && m && r.createElement('div', { className: a('js-button-text', b.text) }, m),
          )
        })
    ...
    uTDg: function (e, t, n) {
        ...
        return a.a.createElement(
          ...
          a.a.createElement(
            ...
            a.a.createElement(
              ...
              !!u && a.a.createElement(h.a, { className: c()(N.icon, N.allExchangesIcon), icon: k }),
            ),
            a.a.createElement(
              'div',
              ...
              a.a.createElement(
                ...
                a.a.createElement(x.a, { className: c()(l && N.highlighted), queryString: m, text: s, rules: f }),
              ),
              b &&
                a.a.createElement(
                  'div',
                  { className: N.description },
                  a.a.createElement(x.a, { className: N.highlighted, queryString: m, rules: f, text: i }),
                ),
            ),
          ),
        )
      ...
      function D(e) {
        const { exchanges: t } = e,
          ...
          p = Object(S.a)({ watchedValue: T.watchedTheme }) === j.a.Dark ? R : M,
          [m, y] = Object(r.useState)(''),
          x = Object(r.useCallback)(
            e => e.name.toLowerCase().includes(m.toLowerCase()) || e.desc.toLowerCase().includes(m.toLowerCase()),
            [m],
          ),
        ...
        const z = u
          ...
          : a.a.createElement(
              ...
              a.a.createElement('div', { className: _.emptyText }, Object(s.t)('No exchanges match your criteria')),
            )
        return a.a.createElement(
          I.a.Provider,
          { value: L },
      ...
      function le(e) {
        ...
        const { state: n, update: o } = e,
          { searchRef: c, forceUpdate: s, upperCaseEnabled: u } = Object(f.ensureNotNull)(Object(r.useContext)(b.a)),
          p = Object(i.b)(null === (t = c.current) || void 0 === t ? void 0 : t.value),
          m = Object(l.h)(p)
        let h = [
      ...
      var de = n('ijHL'),
        pe = n('mHCH')
      function me(e) {
        const { isActive: t, isAnimated: n, activeColor: r, size: a = 'm', appearance: o = 'default', className: s } = e
        return c()(
          pe.bubble,
          t && pe.active,
          r && pe[r],
      ...
      function ke(e) {
        ...
        return p
          ? a.a.createElement(
              ...
              a.a.createElement('div', { className: Oe.title }, m ? Object(s.t)('All sources') : d.name),
      ...
      const we = Object(g.c)()
      function Se(e) {
        const { isSmallWidth: t, selectedExchange: n } = Object(f.ensureNotNull)(Object(r.useContext)(b.a)),
        ...
        return a.a.createElement(
          ...
          a.a.createElement(
            'div',
            { className: Ne.item },
            !t && a.a.createElement('div', { className: Ne.text }, Object(s.t)('Description')),
            o && a.a.createElement('div', { className: Ne.exchange }, a.a.createElement(ke, null)),
          ),
        )
      }
      var Ce = n('Ialn'),
      ...
      function je(e) {
        ...
        return a.a.createElement(
          ...
          a.a.createElement(
            'div',
            { ref: s, className: c()(Te.wrap, x && Te.watchlist, d && Te.noFeed, o), onTouchMove: t },
            a.a.createElement(
              'div',
      ...
      function Me(e) {
        const {
          ...
          k = l && a.a.createElement(BrokerCheckbox, { brokerTitle: l, checked: u, onCheckboxChange: d }),
          N = 'symbolSearch' === f && 'good' === n,
          w = null != x ? x : Ie.a,
          S = Object(r.useMemo)(() => E.map(e => a.a.createElement(w, { ...e, searchToken: t })), [E])
        return a.a.createElement(
          a.a.Fragment,
          null,
          'symbolSearch' === f &&
          ...
          'loading' === n && a.a.createElement('div', { className: Re.spinnerWrap }, a.a.createElement(ve.a, null)),
          'symbolSearch' === f &&
            a.a.createElement(a.a.Fragment, null, !1, 'empty' === n && a.a.createElement(O, null)),
        )
      }
      function _e(e) {
        const t = Object(S.a)({ watchedValue: T.watchedTheme }) === j.a.Dark ? R : M
        return a.a.createElement(
          E,
          { className: Re.noResultsDesktop },
          a.a.createElement(h.a, { icon: t }),
          a.a.createElement('div', { className: Re.emptyText }, Object(s.t)('No symbols match your criteria')),
        )
      }
      const Le = Object(g.e)(),
        De = 52
      function Ae(e) {
        ...
        const A = Object(r.useRef)(new AbortController()),
          ...
          K = Object(r.useRef)({ selectedIndexValue: -1, searchTokenValue: '', searchSpreadsValue: !0 }),
        ...
        Object(r.useEffect)(() => {
          ...
          Object(r.useEffect)(() => {
            ;(Boolean(T) && '' === F.trim()) ||
              (ge(F, m, null == u ? void 0 : u.value), W.current && (W.current.scrollTop = 0))
          }, [F, m, u, oe, T]),
          Object(r.useEffect)(() => {
        ...
        return a.a.createElement(
          ...
          !(_ && 'symbolSearch' === t) &&
            a.a.createElement(
              pe,
              { reference: y, className: c()(Re.search, M && Re.upperCase), placeholder: S || Object(s.t)('Search') },
        ...
        function fe() {
          ...
          ;(V.current = t),
            (K.current = { selectedIndexValue: -1, searchSpreadsValue: Object(l.e)(n), searchTokenValue: e }),
        ...
        function be() {
          d.enabled('show_spread_operators')
            ? fe()
            : y.current &&
              ((K.current = { selectedIndexValue: -1, searchSpreadsValue: !1, searchTokenValue: y.current.value }),
              H.current || (H.current = setTimeout(ve, 0)))
        }
        function ve() {
          const { selectedIndexValue: e, searchTokenValue: t, searchSpreadsValue: n } = K.current
          ;(H.current = null),
          ...
          try {
            ...
            const r = await (async function (e, t, n, r) {
                ...
                const p = d.enabled('show_spread_operators')
                    ? null !== (c = null !== (o = Object(l.c)(t)) && void 0 !== o ? o : i) && void 0 !== c
                      ? c
                      : r
                    : null == u
                    ? void 0
        ...
        function Ee() {
          'watchlist' === D.current &&
            (n('symbolSearch'), Object(J.trackEvent)('Watchlist', 'Mobile SS', 'Go to SS page'))
        }
        function xe(e) {
      ...
      function Ue(e) {
        ...
        const {
          ...
          H = Object(r.useRef)(null !== (t = e.input) && void 0 !== t ? t : null),
        ...
        Object(r.useLayoutEffect)(() => {
          ...
          !(null == H ? void 0 : H.current) ||
            (!L && Boolean(null === (e = H.current) || void 0 === e ? void 0 : e.value)) ||
        ...
        Object(r.useEffect)(() => {
          var e
          ;-1 !== Q && (null === (e = le.current) || void 0 === e || e.scrollIntoView({ block: 'nearest' }))
        }, [Q, le])
        ...
        return a.a.createElement(
          be,
          null,
          a.a.createElement(u.a, { rules: p.a }, ({ TabletSmall: e, TabletNormal: t }) =>
            a.a.createElement(
              b.a.Provider,
              { value: me(e, t) },
        ...
        function ye(e, t) {
          ...
          const o = [{ resolved: !0, symbol: Ve.a.fromSymbolSearchResult(e, t), result: r }]
          h(o), n()
        }
        function Ee(e) {
          J('fixed' === R || e <= 640)
        ...
        function ke(e) {
          ...
          if (d.enabled('show_spread_operators') && X && t) {
            ...
            if (!Ne(t)) return
            return h([{ symbol: He ? t.toUpperCase() : t, resolved: !1 }]), void (e && n())
          }
                    ...
                    e.map(e =>
                      -1 !== e.indexOf(':') || t
                        ...
                        : ((t = !0),
                          (async function (e) {
                            var t
                            null === (t = await (null == ae ? void 0 : ae.accountMetainfo())) ||
                              void 0 === t ||
                              t.prefix
                            const n = await Y({
                              strictMatch: !0,
                            ...
                            if (0 !== n.length) {
                              ...
                              if (a && o) return { symbol: Ve.a.fromSymbolSearchResult(e, r), resolved: !0, result: e }
                            }
    ...
    zjoO: function (e, t, n) {
      ...
      function g(e) {
        const {
          ...
          { isSmallWidth: G, isMobile: W } = Object(s.ensureNotNull)(Object(r.useContext)(d.a)),
          X = Boolean(M),
          K = !C && !j && (W || !X),
          Q = Object(m.a)({ watchedValue: f.watchedTheme }) === p.a.Dark ? v.dark : v.light,
          q = M
        return a.a.createElement(
          'div',
          {
          ...
          a.a.createElement(
            ...
            a.a.createElement(
              ...
              I && a.a.createElement(i.a, { className: c()(v.expandHandle, R && v.expanded), icon: b }),
            ),
            a.a.createElement(
              'div',
              ...
              !n &&
                ...
                a.a.createElement(
                  'div',
                  { className: c()(v.symbolTitle, w && v.active, C && v.invalid), 'data-name': 'list-item-title' },
                  a.a.createElement('span', { dangerouslySetInnerHTML: { __html: t } }),
                  N && a.a.createElement('span', { className: v.dataMode }, 'E'),
                ),
              G && H(),
            ),
          ...
          !G && H(),
          q ? a.a.createElement(q, { ...e, className: v.cell, onMouseOver: void 0, onMouseOut: void 0 }) : null,
          K &&
            a.a.createElement(
              'div',
              ...
              a.a.createElement(
                ...
                a.a.createElement('div', { className: c()(v.marketType, w && v.active) }, x),
                a.a.createElement('div', { className: c()(v.exchangeName, w && v.active) }, E),
              ),
              !1,
            ),
          a.a.createElement('div', { className: c()(v.cell, Boolean(V) && v.actionsCell) }, V),
        )
        function H() {
          if (C) return null
          const e = c()(
          ...
          return g
            ...
            : o
            ? a.a.createElement('div', { className: e, dangerouslySetInnerHTML: { __html: o } })
            : null
        }
      }
    },
