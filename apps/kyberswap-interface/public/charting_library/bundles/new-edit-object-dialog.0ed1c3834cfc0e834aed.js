      ...
      class c extends l.PureComponent {
        render() {
          ...
          return l.createElement(
            ...
            l.createElement('input', { ...a, type: 'checkbox', className: s, ref: e }),
            l.createElement(
              'div',
    ...
    Y5hB: function (e, t, n) {
        ...
        constructor(e) {
          super(e),
            (this._renderFooterLeft = e => {
              ...
              if (Object(C.isLineTool)(t)) return r.createElement(f.a, { source: t, model: n })
        ...
        _renderChildren(e) {
          return ({ requestResize: t }) => {
            ...
            return r.createElement(
              r.Fragment,
              null,
              r.createElement(u.a, { activeTabId: e, onSelect: this._handleSelect, tabs: n }),
              r.createElement(
                g.a,
      ...
      class O extends r.PureComponent {
        render() {
          const { input: e, value: t, onChange: n, onBlur: l, onKeyDown: a } = this.props,
            ...
            i = { ...e, optionsTitles: s }
          return r.createElement(x.b, { input: i, value: t, onChange: n, onBlur: l, onKeyDown: a })
        }
      }
      ...
      class z extends r.PureComponent {
        render() {
          const { input: e } = this.props,
            t = Object(i.ensureNotNull)(this.context),
            n = { ...e, optionsTitles: { fixed: D, cash_per_order: t, percent_of_equity: F } }
          return r.createElement(x.a, { input: n })
        }
      }
      z.contextType = I
      ...
      class G extends r.PureComponent {
        render() {
          ...
          return r.createElement(
            ...
            r.createElement(T.a, { label: window.t('Base currency') }, r.createElement(k, { input: e.currency })),
            r.createElement(
              T.a,
            ...
            r.createElement(
              ...
              r.createElement('span', null, r.createElement(P.a, { input: e.pyramiding })),
              r.createElement(
                'span',
            ...
            r.createElement(
              ...
              r.createElement('span', null, r.createElement(P.a, { input: e.backtest_fill_limits_assumption })),
              r.createElement(
                'span',
                { className: W.descriptionCell },
            ...
            r.createElement(
              ...
              r.createElement('span', null, r.createElement(P.a, { input: e.slippage })),
              r.createElement(
                'span',
                { className: W.descriptionCell },
                window.t('ticks', { context: 'slippage ... ticks' }),
            ...
            Object(H.isFeatureEnabled)('show_strategy_margin_inputs') &&
              ...
              r.createElement(
                ...
                r.createElement(
                  ...
                  r.createElement('span', null, r.createElement(P.a, { input: e.margin_long })),
                  r.createElement('span', { className: W.descriptionCell }, '%'),
                ),
                r.createElement(
                  T.a,
                  { label: window.t('Margin For Short Positions') },
                  r.createElement('span', null, r.createElement(P.a, { input: e.margin_short })),
                  r.createElement('span', { className: W.descriptionCell }, '%'),
                ),
                r.createElement(V.a.Separator, null),
              ),
            r.createElement(
              ...
              r.createElement(
                ...
                r.createElement(
                  ...
                  r.createElement(j.a, { label: window.t('After Order is Filled'), input: e.calc_on_order_fills }),
                ),
                r.createElement(
                  'div',
                  { className: W.recalculateCheckbox },
                  r.createElement(j.a, { label: window.t('On Every Tick'), input: e.calc_on_every_tick }),
                ),
              ),
            ),
          )
      ...
      function A(e) {
        ...
        return r.createElement(N.a, { property: t.inputs, model: n, study: a }, r.createElement(G, { inputs: l }))
      }
      G.contextType = N.b
      var U = n('z61+'),
        q = n('txPx')
      ...
      class Q extends r.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._inputs = new U.a(this.props.source.metaInfo()).getUserEditableInputs())
        }
        render() {
      ...
      var re = n('KKsp'),
        ...
        ge = n('sPU+')
      const ve = {
          [X.LineStudyPlotStyle.Line]: { type: X.LineStudyPlotStyle.Line, order: 0, icon: oe, label: window.t('Line') },
          ...
          [X.LineStudyPlotStyle.Area]: { type: X.LineStudyPlotStyle.Area, order: 6, icon: me, label: window.t('Area') },
            ...
            !a &&
              r.createElement(
                ...
                r.createElement(
                  ...
                  o
                    ? r.createElement('div', null, t ? t.title : s.title.value())
                    : r.createElement(ae, { id: d, title: t ? t.title : s.title.value(), visible: s.visible }),
                ),
              ),
      ...
      class Le extends r.PureComponent {
        ...
        render() {
          const {
            id: e,
            isRGB: t,
            property: { title: n, color: l, plottype: a, linewidth: s, transparency: i, trackPrice: o, visible: c },
          } = this.props
          return r.createElement(
            T.a,
            { label: r.createElement(ae, { id: e, title: n.value(), visible: c }) },
            t
              ? this._getInputForRgb()
              : r.createElement(Ee.a, { disabled: !c.value(), color: l, transparency: i, thickness: s }),
            r.createElement(fe, {
              id: Object(J.a)(e, 'plot-type-select'),
              disabled: !c.value(),
              className: Se.smallStyleControl,
        ...
        _getInputForRgb() {
          ...
          return l && t
            ? r.createElement(ke.a, { id: Object(J.a)(e, 'line-width-select'), property: l, disabled: !a.value() })
            : null
        }
      }
      Le.contextType = te.b
      ...
      class Ve extends r.PureComponent {
        render() {
          ...
          return r.createElement(
            T.a,
            { label: c ? r.createElement(ae, { id: e, title: n, visible: l }) : n, offset: p, grouped: d },
            t
              ? null
              : r.createElement(Ee.a, {
            ...
            r.createElement(
              ...
              r.createElement(
                ...
                r.createElement(
                  ...
                  r.createElement(ae, { id: e, title: pt(Object(i.ensureNotNull)(o), e), visible: s }),
                ),
              ),
              !t &&
                r.createElement(
      ...
      var Me = n('/SnT'),
        ...
        He = n('972a')
      const We = {
          [He.c.AboveBar]: { value: He.c.AboveBar, content: window.t('Above Bar'), order: 0 },
          [He.c.BelowBar]: { value: He.c.BelowBar, content: window.t('Below Bar'), order: 1 },
          [He.c.Top]: { value: He.c.Top, content: window.t('Top'), order: 2 },
          [He.c.Bottom]: { value: He.c.Bottom, content: window.t('Bottom'), order: 3 },
          [He.c.Absolute]: { value: He.c.Absolute, content: window.t('Absolute'), order: 4 },
        },
      ...
      class $e extends r.PureComponent {
        ...
        render() {
          const {
            id: e,
            isRGB: t,
            property: { title: n, color: l, transparency: a, char: s, location: i, visible: o },
            hasPalette: c,
          } = this.props
          return r.createElement(
            T.a,
            { grouped: c, label: r.createElement(ae, { id: e, title: n.value(), visible: o }) },
            !c && !t && r.createElement(Ee.a, { disabled: !o.value(), color: l, transparency: a }),
      ...
      Object.keys(Ke.a).forEach(e => {
        ...
        Je.push({
          ...
          content: s.a.createElement(ie.b, { icon: Qe(t.icon), label: t.guiName }),
        })
      })
      ...
      class tt extends r.PureComponent {
        ...
        render() {
          const {
            ...
            isRGB: t,
            hasPalette: n,
            property: { title: l, color: a, transparency: s, plottype: i, location: o, visible: c },
          } = this.props
          return r.createElement(
            T.a,
            { grouped: n, label: r.createElement(ae, { id: e, title: l.value(), visible: c }) },
            !n && !t && r.createElement(Ee.a, { disabled: !c.value(), color: a, transparency: s }),
            r.createElement(Xe, {
              id: Object(J.a)(e, 'shape-style-select'),
              disabled: !c.value(),
              className: Se.smallStyleControl,
        ...
        render() {
          ...
          if ('line' === s || 'bar_colorer' === s || 'bg_colorer' === s)
            return i && i.palette && i.paletteProps
              ? r.createElement(Oe, { plot: e, palette: i.palette, paletteProps: i.paletteProps, styleProp: a })
              : r.createElement(Le, { id: l, property: a, isRGB: o, showLineWidth: 'line' === s })
          if ('arrows' === s) {
            ...
            return i || c
              ...
              : r.createElement(Ie, { id: l, property: a, isRGB: o, plot: e, palettes: t, styleProp: a })
          }
          if ('chars' === s || 'shapes' === s)
            return r.createElement(
              r.Fragment,
              null,
              'chars' === s
                ? r.createElement($e, { id: l, property: a, hasPalette: Boolean(i && i.palette), isRGB: o })
                : r.createElement(tt, { id: l, property: a, hasPalette: Boolean(i && i.palette), isRGB: o }),
              i &&
                i.palette &&
                i.paletteProps &&
                r.createElement(Oe, {
      ...
      class mt extends s.a.PureComponent {
        ...
        render() {
          ...
          return s.a.createElement(ht.a, { ...t, lineStyle: Object(ne.a)(e), lineStyleChange: this._onLineStyleChange })
        }
      }
      mt.contextType = te.b
      ...
      class wt extends r.PureComponent {
        ...
        render() {
          const {
            id: e,
            property: { name: t, color: n, linestyle: l, linewidth: a, transparency: s, value: i, visible: o },
          } = this.props
          return r.createElement(
            T.a,
            { labelAlign: 'adaptive', label: r.createElement(ae, { id: e, title: t.value(), visible: o }) },
            r.createElement(
              'div',
              { className: Se.block },
              r.createElement(
                'div',
                { className: Se.group },
                r.createElement(Ee.a, { disabled: !o.value(), color: n, transparency: s, thickness: a }),
                r.createElement(mt, {
          ...
          return r.createElement(
            ...
            r.createElement(
              ...
              r.createElement(
                V.a.Cell,
                { placement: 'first', colSpan: 2 },
                r.createElement(ae, { id: 'chart-orders-switch', title: window.t('Trades on Chart'), visible: e }),
              ),
            ),
            r.createElement(
              V.a.Row,
              ...
              r.createElement(
                V.a.Cell,
                { placement: 'first', colSpan: 2 },
                r.createElement(ae, { id: 'chart-orders-labels-switch', title: window.t('Signal Labels'), visible: t }),
              ),
            ),
            r.createElement(
              V.a.Row,
              ...
              r.createElement(
                V.a.Cell,
                { placement: 'first', colSpan: 2 },
                r.createElement(ae, { id: 'chart-orders-qty-switch', title: window.t('Quantity'), visible: n }),
              ),
            ),
          )
        }
          ...
          return r.createElement(
            ...
            r.createElement(
              ...
              r.createElement(
                V.a.Cell,
                { placement: 'first', colSpan: 2, grouped: !0 },
                r.createElement(ae, { id: e.value(), title: e.value(), visible: s }),
              ),
            ),
            r.createElement(
              T.a,
              { label: r.createElement('div', { className: Se.childRowContainer }, ft), grouped: !0 },
            ...
            r.createElement(
              T.a,
              { label: r.createElement('div', { className: Se.childRowContainer }, Et), grouped: !0 },
            ...
            r.createElement(
              ...
              r.createElement(
                V.a.Cell,
                { className: Se.childRowContainer, placement: 'first', colSpan: 2, grouped: !0 },
                r.createElement(j.b, {
                  label: St,
            ...
            r.createElement(
              T.a,
              { label: r.createElement('div', { className: Se.childRowContainer }, Pt), grouped: !0 },
            ...
            .map(a =>
              r.createElement(
                T.a,
                {
                  key: a,
                  grouped: !0,
                  label: r.createElement('div', { className: Se.childRowContainer }, t.childs()[a].value()),
                },
                r.createElement(Ee.a, { disabled: !l.value(), color: e.childs()[a], transparency: n.childs()[a] }),
              ),
            )
        }
      }
      ...
      class jt extends r.PureComponent {
        render() {
          ...
          return r.createElement(
            T.a,
            { label: r.createElement(ae, { id: e.value(), title: e.value(), visible: s }) },
            r.createElement(Ee.a, { disabled: !s.value(), color: t, transparency: n, thickness: l }),
            r.createElement(mt, {
        ...
        render() {
          ...
          return Object.keys(a).map((t, n) => {
            ...
            return 'horizlines' === e || 'vertlines' === e || 'lines' === e
              ? r.createElement(jt, { key: t, title: 'lines' === e ? a.title : a.name, property: a })
              : 'hhists' === e
      ...
      const Lt = window.t('Change Font'),
        Nt = ['Verdana', 'Courier New', 'Times New Roman', 'Arial'].map(e => ({ value: e, content: e }))
      ...
      class Wt extends s.a.PureComponent {
        ...
        render() {
          ...
          return s.a.createElement(
            ...
            s.a.createElement(
              T.a,
              { labelAlign: 'adaptive', label: s.a.createElement('span', null, Ft) },
              s.a.createElement(
                'div',
                { className: Se.block },
                s.a.createElement(
                  'div',
                  { className: Se.group },
                  s.a.createElement(Vt, { id: 'pivot-points-standard-font-family-select', fontFamily: e }),
                ),
                s.a.createElement(
                  'div',
                  { className: Be(Se.wrapGroup, Se.additionalSelect) },
                  s.a.createElement(Bt, { id: 'pivot-points-standard-font-size-select', fontSize: t }),
                ),
              ),
            ),
            s.a.createElement(
          ...
          return s.a.createElement(
            ...
            s.a.createElement(
              ...
              s.a.createElement(
                ...
                s.a.createElement(Ee.a, { disabled: !m.value() || !b[0].value(), color: v }),
              ),
            ),
            s.a.createElement(
              V.a.Row,
              ...
              s.a.createElement(
                V.a.Cell,
                { placement: 'first' },
                s.a.createElement('div', { className: Se.childRowContainer }, qt),
              ),
              s.a.createElement(
                V.a.Cell,
                { placement: 'last' },
            ...
            s.a.createElement(
              ...
              s.a.createElement(
                V.a.Cell,
                { placement: 'first' },
                s.a.createElement('div', { className: Se.childRowContainer }, $t),
              ),
              s.a.createElement(
                V.a.Cell,
                { placement: 'last' },
      ...
      for (let e = 0; e < dn.length; e++) {
        const t = dn[e]
        hn.push({ value: t.priceScale + ',' + t.minMove + ',' + t.frac, content: t.minMove + '/' + t.priceScale })
      }
      ...
      class bn extends r.PureComponent {
        ...
        render() {
          ...
          return r.createElement(
            ...
            i && r.createElement(sn, { id: Object(J.a)(t.id, 'precision-select'), precision: l }),
            o && r.createElement(un, { id: Object(J.a)(t.id, 'min-tick-select'), minTick: s }),
            ee.a.isScriptStrategy(t) && r.createElement(gt, { orders: a.orders }),
          )
        }
        _plotsElement() {
          const { study: e } = this.props,
          ...
          return new U.a(t)
            ...
            .map(t => {
              ...
              return r.createElement(ct, { key: t.id, plot: t, palettes: l, study: e })
            })
        }
        _bandsElement() {
          const { study: e } = this.props,
          ...
          return (
            ...
            n.childNames().map((e, t) => {
              ...
              if (!l.isHidden || !l.isHidden.value())
                return r.createElement(wt, { key: t, id: l.name.value(), property: l })
            })
          )
        }
        ...
        _graphicsElement() {
          ...
          return t && Object.keys(t).map((t, n) => r.createElement(Tt, { key: t, graphicType: t, study: e }))
        }
        _findPalettesByTargetId(e) {
          ...
          for (const n of l)
            (Object(X.isColorerPlot)(n) || Object(X.isOhlcColorerPlot)(n)) &&
              n.target === e &&
              (r.main = { palette: a[n.palette], paletteProps: t.properties().palettes[n.palette] }),
              Object(X.isUpColorerPlot)(n) &&
                n.target === e &&
                (r.up = { palette: a[n.palette], paletteProps: t.properties().palettes[n.palette] }),
              Object(X.isDownColorerPlot)(n) &&
                n.target === e &&
                (r.down = { palette: a[n.palette], paletteProps: t.properties().palettes[n.palette] }),
              Object(X.isCandleWickColorerPlot)(n) &&
                n.target === e &&
                (r.wick = { palette: a[n.palette], paletteProps: t.properties().palettes[n.palette] }),
              Object(X.isCandleBorderColorerPlot)(n) &&
                n.target === e &&
                (r.border = { palette: a[n.palette], paletteProps: t.properties().palettes[n.palette] })
          return r
        }
      }
      function wn(e) {
      ...
      class fn extends yn.a {
        ...
        show(e = {}) {
          ...
          if (
            (Object(C.isLineTool)(this._source) &&
              Object(h.trackEvent)('GUI', 'Drawing Properties', this._source.name()),
          ...
          l.hasUserEditableInputs() && n.allIds.push('inputs'),
            ...
            this._propertyPages ||
              ((n.byId.visibilities = { title: window.t('Visibility'), page: this._createVisibilitiesPropertyPage() }),
        ...
        _getPagesForStudyLineTool(e) {
          if (this._propertyPages) {
            ...
            return { allIds: [...e.allIds, ...n.allIds], byId: { ...e.byId, ...n.byId } }
          }
          return e
        }
    ...
    lgIt: function (e, t, n) {
      ...
      function f(e, t, n) {
        ...
        if (l.enabled('tick_resolution')) {
          const l = Object(a.c)(
            { checked: Object(a.b)(e, t.ticks, `Change ${n} Visibility On Ticks`) },
        ...
        if (Object(i.isSecondsEnabled)()) {
          const l = Object(a.n)(
            {
              checked: Object(a.b)(e, t.seconds, `Change ${n} Visibility On Seconds`),
              from: Object(a.b)(e, t.secondsFrom, `Change ${n} Seconds From`),
              to: Object(a.b)(e, t.secondsTo, `Change ${n} Seconds To`),
            },
            { id: 'IntervalsVisibilitiesSecond', title: c, min: new s.a(b[0]), max: new s.a(b[1]) },
          )
          r.push(l)
        }
        const f = Object(a.n)(
            {
              checked: Object(a.b)(e, t.minutes, `Change ${n} Visibility On Minutes`),
              from: Object(a.b)(e, t.minutesFrom, `Change ${n} Minutes From`),
              to: Object(a.b)(e, t.minutesTo, `Change ${n} Minutes To`),
            },
            { id: 'IntervalsVisibilitiesMinutes', title: p, min: new s.a(w[0]), max: new s.a(w[1]) },
          ),
          E = Object(a.n)(
            {
              checked: Object(a.b)(e, t.hours, `Change ${n} Visibility On Hours`),
              from: Object(a.b)(e, t.hoursFrom, `Change ${n} Hours From`),
              to: Object(a.b)(e, t.hoursTo, `Change ${n} Hours To`),
            },
            { id: 'IntervalsVisibilitiesHours', title: d, min: new s.a(g[0]), max: new s.a(g[1]) },
          ),
          S = Object(a.n)(
            {
            ...
            { id: 'IntervalsVisibilitiesDays', title: h, min: new s.a(v[0]), max: new s.a(v[1]) },
          )
        r.push(f, E, S)
        const P = Object(a.n)(
            {
              checked: Object(a.b)(e, t.weeks, `Change ${n} Visibility On Weeks`),
              from: Object(a.b)(e, t.weeksFrom, `Change ${n} Weeks From`),
              to: Object(a.b)(e, t.weeksTo, `Change ${n} Weeks To`),
            },
            { id: 'IntervalsVisibilitiesWeeks', title: u, min: new s.a(y[0]), max: new s.a(y[1]) },
          ),
          _ = Object(a.n)(
            {
              checked: Object(a.b)(e, t.months, `Change ${n} Visibility On Months`),
              from: Object(a.b)(e, t.monthsFrom, `Change ${n} Months From`),
              to: Object(a.b)(e, t.monthsTo, `Change ${n} Months To`),
            },
            { id: 'IntervalsVisibilitiesMonths', title: m, min: new s.a(C[0]), max: new s.a(C[1]) },
          )
        return r.push(P, _), r
      }
    },
