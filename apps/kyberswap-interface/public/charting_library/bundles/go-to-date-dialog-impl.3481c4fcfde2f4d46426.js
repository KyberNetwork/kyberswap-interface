  ...
  ['go-to-date-dialog-impl'],
  {
    ...
    '02pg': function (e, t, n) {
      ...
      var s = n('q1tI'),
        ...
        a = n('XiJV')
      function r(e) {
        return s.createElement('div', { className: o(a.separator, e.className) })
      }
    },
    '2A9e': function (e) {
      ...
      function p(e) {
        ...
        return o.a.createElement(
          d,
          {
            ...
            role: n,
            'aria-selected': u,
            className: a(p, F.item, w && F.withIcon, { [F.isActive]: C, [F.isDisabled]: D || E, [F.hovered]: _ }),
            title: m,
            href: S,
            target: y,
            rel: k,
          ...
          void 0 !== w && o.a.createElement('div', { className: F.icon, dangerouslySetInnerHTML: { __html: w } }),
          o.a.createElement(
            'div',
          ...
          (void 0 !== v || g) &&
            o.a.createElement('div', { className: F.shortcut }, (A = v) && A.split('+').join(' + ')),
          void 0 !== x &&
            o.a.createElement('div', { onClick: P ? h : void 0, className: a(F.toolbox, { [F.showOnHover]: O }) }, x),
        )
        var A
      }
    },
    ...
    aDg1: function (e, t, n) {
      ...
      class m extends s.PureComponent {
        ...
        render() {
          const { theme: e = h, hiddenBottomBorders: t, fadedSlider: n = !0, ScrollComponent: a = l.a } = this.props,
          ...
          return s.createElement(
            ...
            s.createElement(
              ...
              s.createElement(
                ...
                s.createElement(p, { className: o(e.tabs, t && e.withoutBorder) }, r),
              ),
            ),
          )
        }
        ...
        return o.a.createElement(
          ...
          o.a.createElement(
            ...
            o.a.createElement(
              ...
              n && o.a.createElement('div', { className: i()(C.ellipsis, C.subtitle) }, n),
            ),
            l,
            a &&
              !p &&
          ...
          return o.a.createElement(p.a, { rule: h.a.SmallHeight }, c =>
            o.a.createElement(p.a, { rule: h.a.TabletSmall }, l =>
              o.a.createElement(
                ...
                o.a.createElement(
                  'div',
                  { className: _.wrapper, 'data-name': a, 'data-dialog-name': 'string' == typeof s ? s : '' },
                  void 0 !== s &&
                    o.a.createElement(D, {
                      draggable: w && !(l || C),
    ...
    mwqF: function (e, t, n) {
      ...
      function u(e) {
        const {
          ...
          { isGrouped: g, cellState: w, disablePositionAdjustment: C } = Object(s.useContext)(r.a),
          D = c(l, {
            intent: n,
            size: i,
            appearance: u,
    ...
    'uUY/': function (e, t, n) {
      ...
      function M(e) {
        const { children: t } = e
        return o.a.createElement('div', { className: k()(R.row, _e && R.mobileRow) }, t)
      }
      var A = n('8+VR'),
        B = n('gQ5K'),
        z = n('Iivm'),
      ...
      class q extends s.PureComponent {
        constructor() {
          super(...arguments), (this._renderWeekdays = () => H.map(e => s.createElement('span', { key: e }, e)))
        }
        render() {
          return s.createElement(
            'div',
            { className: W.month },
            s.createElement('div', { className: W.weekdays }, this._renderWeekdays()),
        ...
        _renderWeek(e) {
          ...
          for (let a = 0; a < 7; a++) {
            ...
            r.setDate(r.getDate() + a),
              ((n = r), (o = this.props.viewDate), Number(h(n)) === Number(h(o))) &&
                t.push(
                  s.createElement(K, {
                    key: a,
                    day: r,
      ...
      class V extends s.PureComponent {
        ...
        render() {
          return s.createElement(
            'div',
            { className: y(W.calendar, this.props.popupStyle && W.popupStyle, this.props.className), tabIndex: -1 },
            s.createElement(
              'div',
              { className: W.header },
              s.createElement(z.a, { icon: L, onClick: this._prevMonth, className: y(W.switchBtn, W.prev) }),
              s.createElement(
                'div',
                { className: W.title },
                `${U[this.state.viewDate.getMonth()]} ${this.state.viewDate.getFullYear()}`,
              ),
              s.createElement(z.a, { icon: L, onClick: this._nextMonth, className: y(W.switchBtn, W.next) }),
            ),
            s.createElement(q, {
        ...
        render() {
          ...
          return s.createElement(
            ...
            this.props.showPicker && !a
              ? s.createElement(Q.a, { mouseDown: !0, handler: this.props.onHidePicker }, t =>
                  s.createElement(
                    'span',
                    { ref: t },
                    s.createElement(
                      'div',
                      { className: y(Z.picker, Z[e]), key: '0', ref: this._onShowPicker },
                      this.props.children,
                    ),
                  ),
                )
              ...
              endSlot:
                n && n.length
                  ...
                  : s.createElement(
                      Y.b,
                      null,
                      s.createElement(z.a, { icon: this.props.icon, className: y(Z.icon, t && Z.disabled) }),
                    ),
              className: e,
      ...
      function ie(e) {
        ...
        return o.a.createElement(
          ...
          t && o.a.createElement(oe, { text: Object(O.t)('Please enter the right date'), className: re.tooltip }),
        )
      }
      ...
      var pe = n('vx8J')
      function me(e) {
        return o.a.createElement(V, { ...e, className: pe.calendar, popupStyle: !1 })
      }
      function fe(e, t) {
        const n = new Date(t)
      ...
      function ge(e) {
        const { dateOnly: t, onCalendarMonthSwitch: n, onDateInputFocus: a } = e,
          { dateFrom: r, dateTo: c, setDateFrom: l, setDateTo: u } = Object(i.ensureNotNull)(Object(s.useContext)(N)),
        ...
        function v(e, t, n) {
          ...
          n(be(r, t)), _e || null === (s = p.current) || void 0 === s || s.focus({ preventScroll: !0 })
        }
      }
      var we = n('aDg1'),
        Ce = n('/KDZ'),
      ...
      const _e = A.mobiletouch,
        Ee = () => !0,
        Ne = {
          byId: { Date: { title: Object(O.t)('Date') }, CustomRange: { title: Object(O.t)('Custom range') } },
      ...
      function Se(e) {
        const { dateOnly: t, onClose: n, onGoToDate: a, onGoToRange: r } = e,
          ...
          { dateFrom: f, dateTo: b, isValid: v } = Object(i.ensureNotNull)(Object(s.useContext)(N))
        return (
          Object(s.useEffect)(
            () => (
          ...
          return (
            ...
            o.a.createElement(
              ...
              o.a.createElement(
                'div',
                { className: De.tabs },
                o.a.createElement(we.a, { activeTabId: l, tabs: Ne, onSelect: E }),
              ),
              o.a.createElement(
                'div',
                ...
                o.a.createElement(
                  ...
                  o.a.createElement(Oe, { onCalendarMonthSwitch: S, onDateInputFocus: S, activeTab: l, dateOnly: t }),
                ),
              ),
            )
          )
      ...
      function Oe(e) {
        ...
        switch (t) {
          case 'Date':
            return o.a.createElement(ve, { dateOnly: n, onCalendarMonthSwitch: s })
          case 'CustomRange':
      ...
      function ye(e) {
        ...
        return o.a.createElement(
          ...
          o.a.createElement(
            S,
            { initialRanges: i },
            o.a.createElement(Se, { dateOnly: t, onClose: n, onGoToDate: s, onGoToRange: a }),
          ),
        )
      }
      var ke = n('pPtI'),
            ...
            onGoToRange: (t, n) => {
              !(function (e, t, n) {
                ...
                const o = c.linking.interval.value(),
                  ...
                  l = g(t).valueOf(),
                  u = g(n).valueOf(),
                  d = { val: { type: 'time-range', from: i(l) / 1e3, to: i(u) / 1e3 }, res: a }
              ...
              o.a.createElement(
                ...
                o.a.createElement(
                  ...
                  o.a.createElement(
                    ...
                    o.a.createElement(
                      i.a,
                      { className: p, disabled: c, name: 'submit', onClick: l, 'data-name': 'submit-button' },
