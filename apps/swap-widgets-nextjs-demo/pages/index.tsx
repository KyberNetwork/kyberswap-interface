...
export default function Home() {
  ...
  // Hydrate app theme from localStorage after mount (avoids SSR mismatch).
  // The `dark` class itself is set in `_document.tsx` before React hydrates
  // so there is no flash; this effect just syncs React state with it.
  useEffect(() => {
