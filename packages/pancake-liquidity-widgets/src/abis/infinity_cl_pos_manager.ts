export const InfinityCLPosManagerABI = [
  {
    inputs: [
      ...
      {
        internalType: "contract ICLPositionDescriptor",
  ...
  { inputs: [], name: "VaultMustBeUnlocked", type: "error" },
  {
    anonymous: false,
    inputs: [
      {
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "CLPositionInfo", name: "info", type: "uint256" },
    ],
    stateMutability: "view",
    type: "function",
  },
