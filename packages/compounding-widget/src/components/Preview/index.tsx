...
export default function Preview({
  ...
  const { refundInfo, addedAmountInfo, positionAmountInfo, zapImpact } = parseZapInfo({
    zapInfo,
    token0,
    token1,
    position,
  ...
  }, [account, chainId, deadline, rpcUrl, zapInfo.route]);
      ...
      <div className="ks-cw-preview">
        <div className="flex items-center h-9 gap-4 mt-4 text-base">
          <div className="relative flex items-center">
            ...
            <TokenLogo src={pool.token1.logo} size={36} className="border-2 border-layer1 -ml-2" />
            <TokenLogo
              src={NETWORKS_INFO[chainId].logo}
              size={18}
              className="border-2 border-layer1 absolute bottom-0 -right-2"
            />
          </div>
        ...
        <div className="ks-cw-card mt-4">
          <div className="ks-cw-card-title">
            <p>Earning to Reinvest</p>
        ...
        {isUniV3 ? (
          <div className="ks-cw-card border border-stroke bg-transparent mt-4 text-sm">
            <div className="flex justify-between items-center gap-4 w-full">
              <div className="ks-cw-card-title">Current pool price</div>
            ...
            {priceRange && (
              <div className="flex justify-between items-center gap-4 w-full mt-2">
                <div className="ks-cw-card flex flex-col gap-[6px] items-center flex-1 w-1/2">
                  <div className="ks-cw-card-title">Min Price</div>
                  <div
                    title={priceRange[0]}
                ...
                <div className="ks-cw-card flex flex-col gap-[6px] items-center flex-1 w-1/2">
                  <div className="ks-cw-card-title">Max Price</div>
                  <div
                    title={priceRange[1]}
                ...
                <div className="flex gap-1">
                  {pool?.token0?.logo && (
                    <TokenLogo
                      ...
                      size={16}
                      className={`relative ${positionId ? '' : 'mt-1 -top-1'}`}
                    />
                  )}
                  <div>
                    {formatDisplayNumber(
