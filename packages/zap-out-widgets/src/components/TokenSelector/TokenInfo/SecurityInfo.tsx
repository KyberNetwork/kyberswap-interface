...
import CollapseInfoItem from '@/components/TokenSelector/TokenInfo/CollapseInfoItem';
import useSecurityTokenInfo from '@/components/TokenSelector/TokenInfo/useSecurityTokenInfo';
import { useZapOutContext } from '@/stores';

const SecurityInfo = ({ token }: { token: Token }) => {
  const { theme, chainId } = useZapOutContext(s => s);
