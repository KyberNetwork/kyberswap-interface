...
export const PUBLIC_RPC_ENDPOINTS: Record<number, string[]> = {
  ...
  [ChainId.Linea]: ['https://linea.drpc.org', 'https://linea-rpc.publicnode.com', 'https://rpc.linea.build'],
  [ChainId.ZkSync]: ['https://rpc.ankr.com/zksync_era', 'https://zksync.drpc.org', 'https://mainnet.era.zksync.io'],
  [ChainId.Blast]: [
    'https://rpc.blast.io',
  ...
  [ChainId.Mantle]: ['https://rpc.mantle.xyz', 'https://mantle-rpc.publicnode.com', 'https://mantle-public.nodies.app'],
  [ChainId.Scroll]: ['https://rpc.scroll.io', 'https://scroll.drpc.org', 'https://scroll-rpc.publicnode.com'],
  [ChainId.Berachain]: [
    'https://rpc.berachain-apis.com',
    'https://berachain-rpc.publicnode.com',
    'https://rpc.berachain.com',
  ],
  [ChainId.Sonic]: ['https://sonic.drpc.org', 'https://sonic-rpc.publicnode.com', 'https://rpc.soniclabs.com'],
  [HYPEREVM]: ['https://rpc.hyperliquid.xyz/evm', 'https://rpc.hypurrscan.io', 'https://hyperliquid.drpc.org'],
  [PLASMA]: ['https://plasma.drpc.org', 'https://rpc.plasma.to', 'https://plasma.gateway.tenderly.co'],
