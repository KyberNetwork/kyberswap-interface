  ...
  return (
    <>
      ...
      <div
        ...
        ref={ref}
      >
        <div className="text-base font-medium mb-5">{t`Advanced Setting`}</div>
        <MouseoverTooltip
          ...
          className="w-fit"
        >
          <div className="text-sm border-b border-dotted border-subText w-fit">{t`Slippage Tolerance`}</div>
        </MouseoverTooltip>
        ...
        <div className="flex items-center justify-between mt-3">
          <MouseoverTooltip
            ...
            width="220px"
          >
            <div className="text-sm border-b border-dotted border-subText">{t`Transaction Time Limit`}</div>
          </MouseoverTooltip>
        ...
        >
          <MouseoverTooltip
            ...
            width="220px"
          >
            <div className="text-sm border-b border-dotted border-subText">{t`Degen Mode`}</div>
          </MouseoverTooltip>
          <Toggle
            isActive={degenMode}
            toggle={() => {
