...
import useShowLoadingAtLeastTime from './useShowLoadingAtLeastTime';
...
const Spin = ({
  ...
  const spinning = !countdown && !disableRefresh;
  ...
  return (
    <svg
      ...
      width="24"
      height="24"
      className={cn(spinning && 'animate-spin duration-700 ease-linear repeat-infinite')}
    >
      <path
        stroke="none"
        fill={color + '66'}
    ...
    >
      ...
      >
        <>
          ...
          {countdown > 0 && !disableRefresh && (
            <div className="text-xs font-medium absolute ml-auto mr-auto w-full left-0 right-0 text-center text-accent">
